...
The 2 policies implemented: FCFS,and LOTTERY. 
...
* **Ali Bagheri** - *Added fcfs and lottery scheduling algorithms, edited nice and reorganization of all scheduling polices (whith descriptions and optimizations)* - [marf](https://github.com/aibgr)
