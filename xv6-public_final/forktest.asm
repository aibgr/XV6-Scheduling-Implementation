...
main(void)
{
  ...
  exit();
   b:	e8 8a 03 00 00       	call   39a <exit>
...
00000010 <printf>:
{
  ...
  28:	e8 dd 03 00 00       	call   40a <write>
}
  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  5c:	6a 01                	push   $0x1
  5e:	e8 a7 03 00 00       	call   40a <write>
  ...
  7b:	0f 84 83 00 00 00    	je     104 <forktest+0xc4>
    pid = fork();
  81:	e8 0c 03 00 00       	call   392 <fork>
    if(pid < 0)
  ...
  8e:	66 90                	xchg   %ax,%ax
    if(wait() < 0){
  90:	e8 0d 03 00 00       	call   3a2 <wait>
  ...
  if(wait() != -1){
  9e:	e8 ff 02 00 00       	call   3a2 <wait>
  ...
  be:	6a 01                	push   $0x1
  c0:	e8 45 03 00 00       	call   40a <write>
}
  ...
  e5:	6a 01                	push   $0x1
  e7:	e8 1e 03 00 00       	call   40a <write>
      exit();
  ec:	e8 a9 02 00 00       	call   39a <exit>
  ...
  fa:	e8 11 ff ff ff       	call   10 <printf>
    exit();
  ff:	e8 96 02 00 00       	call   39a <exit>
 ...
 111:	e8 fa fe ff ff       	call   10 <printf>
    exit();
 116:	e8 7f 02 00 00       	call   39a <exit>
