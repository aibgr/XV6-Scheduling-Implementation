...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 57 39 00 00       	call   3982 <open>
    ...
    exit();
      40:	e8 d5 38 00 00       	call   391a <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 2c 39 00 00       	call   3982 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 54 39 00 00       	call   39b2 <close>
  ...
  exit();
     10d:	e8 08 38 00 00       	call   391a <exit>
...
00000120 <iputtest>:
{
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 2c 38 00 00       	call   399a <unlink>
  ...
  if(chdir("/") < 0){
    ...
    printf(stdout, "chdir / failed\n");
     187:	a1 1c 5f 00 00       	mov    0x5f1c,%eax
  if(chdir("/") < 0){
     18c:	85 d2                	test   %edx,%edx
     18e:	78 2a                	js     1ba <iputtest+0x9a>
  printf(stdout, "iput test ok\n");
     190:	83 ec 08             	sub    $0x8,%esp
     193:	68 f4 3e 00 00       	push   $0x3ef4
     198:	50                   	push   %eax
     199:	e8 22 39 00 00       	call   3ac0 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     1a3:	50                   	push   %eax
     1a4:	50                   	push   %eax
     1a5:	68 28 3e 00 00       	push   $0x3e28
     1aa:	ff 35 1c 5f 00 00    	push   0x5f1c
     1b0:	e8 0b 39 00 00       	call   3ac0 <printf>
    exit();
     1b5:	e8 60 37 00 00       	call   391a <exit>
    printf(stdout, "chdir / failed\n");
     1ba:	52                   	push   %edx
     1bb:	52                   	push   %edx
     1bc:	68 73 3e 00 00       	push   $0x3e73
     1c1:	50                   	push   %eax
     1c2:	e8 f9 38 00 00       	call   3ac0 <printf>
    exit();
     1c7:	e8 4e 37 00 00       	call   391a <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cc:	51                   	push   %ecx
     1cd:	51                   	push   %ecx
     1ce:	68 57 3e 00 00       	push   $0x3e57
     1d3:	ff 35 1c 5f 00 00    	push   0x5f1c
     1d9:	e8 e2 38 00 00       	call   3ac0 <printf>
    exit();
     1de:	e8 37 37 00 00       	call   391a <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e3:	50                   	push   %eax
     1e4:	50                   	push   %eax
     1e5:	68 36 3e 00 00       	push   $0x3e36
     1ea:	ff 35 1c 5f 00 00    	push   0x5f1c
     1f0:	e8 cb 38 00 00       	call   3ac0 <printf>
    exit();
     1f5:	e8 20 37 00 00       	call   391a <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 1c 5f 00 00    	push   0x5f1c
     211:	e8 aa 38 00 00       	call   3ac0 <printf>
  pid = fork();
     216:	e8 f7 36 00 00       	call   3912 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 75 37 00 00       	call   39aa <mkdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 35 37 00 00       	call   399a <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 a9 36 00 00       	call   391a <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 a5 36 00 00       	call   3922 <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 a6 3e 00 00       	push   $0x3ea6
     285:	ff 35 1c 5f 00 00    	push   0x5f1c
     ...
     2a0:	ff 35 1c 5f 00 00    	push   0x5f1c
     2a6:	e8 15 38 00 00       	call   3ac0 <printf>
      exit();
     2ab:	e8 6a 36 00 00       	call   391a <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 69 4d 00 00       	push   $0x4d69
     2b7:	ff 35 1c 5f 00 00    	push   0x5f1c
     2bd:	e8 fe 37 00 00       	call   3ac0 <printf>
    exit();
     2c2:	e8 53 36 00 00       	call   391a <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 28 3e 00 00       	push   $0x3e28
     2ce:	ff 35 1c 5f 00 00    	push   0x5f1c
     2d4:	e8 e7 37 00 00       	call   3ac0 <printf>
      exit();
     2d9:	e8 3c 36 00 00       	call   391a <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 92 3e 00 00       	push   $0x3e92
     2e5:	ff 35 1c 5f 00 00    	push   0x5f1c
     2eb:	e8 d0 37 00 00       	call   3ac0 <printf>
      exit();
     2f0:	e8 25 36 00 00       	call   391a <exit>
...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 3b 36 00 00       	call   3982 <open>
    if(fd >= 0){
     ...
     351:	68 50 4e 00 00       	push   $0x4e50
     356:	ff 35 1c 5f 00 00    	push   0x5f1c
     35c:	e8 5f 37 00 00       	call   3ac0 <printf>
      exit();
     361:	e8 b4 35 00 00       	call   391a <exit>
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 65 35 00 00       	call   391a <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 69 4d 00 00       	push   $0x4d69
     3bc:	ff 35 1c 5f 00 00    	push   0x5f1c
     3c2:	e8 f9 36 00 00       	call   3ac0 <printf>
    exit();
     3c7:	e8 4e 35 00 00       	call   391a <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 cd 3e 00 00       	push   $0x3ecd
     3d3:	ff 35 1c 5f 00 00    	push   0x5f1c
     3d9:	e8 e2 36 00 00       	call   3ac0 <printf>
    exit();
     3de:	e8 37 35 00 00       	call   391a <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 e1 3e 00 00       	push   $0x3ee1
     3ea:	ff 35 1c 5f 00 00    	push   0x5f1c
     3f0:	e8 cb 36 00 00       	call   3ac0 <printf>
    exit();
     3f5:	e8 20 35 00 00       	call   391a <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 1c 5f 00 00    	push   0x5f1c
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 5e 35 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 7e 35 00 00       	call   39b2 <close>
  fd = open("doesnotexist", 0);
     434:	59                   	pop    %ecx
     435:	58                   	pop    %eax
     436:	6a 00                	push   $0x0
     438:	68 25 3f 00 00       	push   $0x3f25
     43d:	e8 40 35 00 00       	call   3982 <open>
  if(fd >= 0){
     442:	83 c4 10             	add    $0x10,%esp
  fd = open("doesnotexist", 0);
     445:	89 c2                	mov    %eax,%edx
    printf(stdout, "open doesnotexist succeeded!\n");
     447:	a1 1c 5f 00 00       	mov    0x5f1c,%eax
  if(fd >= 0){
     44c:	85 d2                	test   %edx,%edx
     44e:	79 2a                	jns    47a <opentest+0x7a>
  printf(stdout, "open test ok\n");
     450:	83 ec 08             	sub    $0x8,%esp
     453:	68 50 3f 00 00       	push   $0x3f50
     458:	50                   	push   %eax
     459:	e8 62 36 00 00       	call   3ac0 <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     463:	50                   	push   %eax
     464:	50                   	push   %eax
     465:	68 12 3f 00 00       	push   $0x3f12
     46a:	ff 35 1c 5f 00 00    	push   0x5f1c
     470:	e8 4b 36 00 00       	call   3ac0 <printf>
    exit();
     475:	e8 a0 34 00 00       	call   391a <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     47a:	52                   	push   %edx
     47b:	52                   	push   %edx
     47c:	68 32 3f 00 00       	push   $0x3f32
     481:	50                   	push   %eax
     482:	e8 39 36 00 00       	call   3ac0 <printf>
    exit();
     487:	e8 8e 34 00 00       	call   391a <exit>
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 1c 5f 00 00    	push   0x5f1c
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 c9 34 00 00       	call   3982 <open>
  if(fd >= 0){
     4b9:	83 c4 10             	add    $0x10,%esp
  fd = open("small", O_CREATE|O_RDWR);
     4bc:	89 c6                	mov    %eax,%esi
    printf(stdout, "creat small succeeded; ok\n");
     4be:	a1 1c 5f 00 00       	mov    0x5f1c,%eax
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4d0:	68 75 3f 00 00       	push   $0x3f75
     4d5:	50                   	push   %eax
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 9a 34 00 00       	call   398a <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 7e 34 00 00       	call   398a <write>
  ...
  i = read(fd, buf, 2000);
     ...
     576:	53                   	push   %ebx
     577:	e8 b6 33 00 00       	call   3932 <read>
  if(i == 2000){
     57c:	83 c4 10             	add    $0x10,%esp
  i = read(fd, buf, 2000);
     57f:	89 c2                	mov    %eax,%edx
    printf(stdout, "read succeeded ok\n");
     581:	a1 1c 5f 00 00       	mov    0x5f1c,%eax
  if(i == 2000){
     586:	81 fa d0 07 00 00    	cmp    $0x7d0,%edx
     58c:	0f 85 8c 00 00 00    	jne    61e <writetest+0x18e>
    printf(stdout, "read succeeded ok\n");
     592:	83 ec 08             	sub    $0x8,%esp
     595:	68 01 40 00 00       	push   $0x4001
     59a:	50                   	push   %eax
     59b:	e8 20 35 00 00       	call   3ac0 <printf>
  close(fd);
     5a0:	89 1c 24             	mov    %ebx,(%esp)
     5a3:	e8 0a 34 00 00       	call   39b2 <close>
  if(unlink("small") < 0){
     5a8:	c7 04 24 6f 3f 00 00 	movl   $0x3f6f,(%esp)
     5af:	e8 e6 33 00 00       	call   399a <unlink>
     5b4:	83 c4 10             	add    $0x10,%esp
     5b7:	89 c2                	mov    %eax,%edx
    printf(stdout, "unlink small failed\n");
     5b9:	a1 1c 5f 00 00       	mov    0x5f1c,%eax
  if(unlink("small") < 0){
     5be:	85 d2                	test   %edx,%edx
     5c0:	78 6e                	js     630 <writetest+0x1a0>
  printf(stdout, "small file test ok\n");
     5c2:	83 ec 08             	sub    $0x8,%esp
     5c5:	68 29 40 00 00       	push   $0x4029
     5ca:	50                   	push   %eax
     5cb:	e8 f0 34 00 00       	call   3ac0 <printf>
}
     ...
     5dd:	53                   	push   %ebx
     5de:	68 74 4e 00 00       	push   $0x4e74
     5e3:	ff 35 1c 5f 00 00    	push   0x5f1c
     5e9:	e8 d2 34 00 00       	call   3ac0 <printf>
      exit();
     5ee:	e8 27 33 00 00       	call   391a <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     5f3:	83 ec 04             	sub    $0x4,%esp
     5f6:	53                   	push   %ebx
     5f7:	68 98 4e 00 00       	push   $0x4e98
     5fc:	ff 35 1c 5f 00 00    	push   0x5f1c
     602:	e8 b9 34 00 00       	call   3ac0 <printf>
      exit();
     607:	e8 0e 33 00 00       	call   391a <exit>
    printf(stdout, "error: open small failed!\n");
     60c:	53                   	push   %ebx
     60d:	53                   	push   %ebx
     60e:	68 e6 3f 00 00       	push   $0x3fe6
     613:	50                   	push   %eax
     614:	e8 a7 34 00 00       	call   3ac0 <printf>
    exit();
     619:	e8 fc 32 00 00       	call   391a <exit>
    printf(stdout, "read failed\n");
     61e:	51                   	push   %ecx
     61f:	51                   	push   %ecx
     620:	68 2d 43 00 00       	push   $0x432d
     625:	50                   	push   %eax
     626:	e8 95 34 00 00       	call   3ac0 <printf>
    exit();
     62b:	e8 ea 32 00 00       	call   391a <exit>
    printf(stdout, "unlink small failed\n");
     630:	52                   	push   %edx
     631:	52                   	push   %edx
     632:	68 14 40 00 00       	push   $0x4014
     637:	50                   	push   %eax
     638:	e8 83 34 00 00       	call   3ac0 <printf>
    exit();
     63d:	e8 d8 32 00 00       	call   391a <exit>
    printf(stdout, "error: creat small failed!\n");
     642:	52                   	push   %edx
     643:	52                   	push   %edx
     644:	68 90 3f 00 00       	push   $0x3f90
     649:	50                   	push   %eax
     64a:	e8 71 34 00 00       	call   3ac0 <printf>
    exit();
     64f:	e8 c6 32 00 00       	call   391a <exit>
...
00000660 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     668:	68 3d 40 00 00       	push   $0x403d
     66d:	ff 35 1c 5f 00 00    	push   0x5f1c
     673:	e8 48 34 00 00       	call   3ac0 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     678:	58                   	pop    %eax
     679:	5a                   	pop    %edx
     67a:	68 02 02 00 00       	push   $0x202
     67f:	68 b7 40 00 00       	push   $0x40b7
     684:	e8 f9 32 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     6a3:	89 1d 60 86 00 00    	mov    %ebx,0x8660
    if(write(fd, buf, 512) != 512){
     6a9:	68 00 02 00 00       	push   $0x200
     6ae:	68 60 86 00 00       	push   $0x8660
     6b3:	56                   	push   %esi
     6b4:	e8 d1 32 00 00       	call   398a <write>
  ...
  close(fd);
     ...
     6d5:	56                   	push   %esi
     6d6:	e8 d7 32 00 00       	call   39b2 <close>
  fd = open("big", O_RDONLY);
     6db:	5e                   	pop    %esi
     6dc:	58                   	pop    %eax
     6dd:	6a 00                	push   $0x0
     6df:	68 b7 40 00 00       	push   $0x40b7
     6e4:	e8 99 32 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    if(((int*)buf)[0] != n){
     70b:	a1 60 86 00 00       	mov    0x8660,%eax
    ...
    i = read(fd, buf, 512);
     ...
     723:	68 60 86 00 00       	push   $0x8660
     728:	53                   	push   %ebx
     729:	e8 04 32 00 00       	call   3932 <read>
    if(i == 0){
  ...
  close(fd);
     ...
     744:	53                   	push   %ebx
     745:	e8 68 32 00 00       	call   39b2 <close>
  if(unlink("big") < 0){
     74a:	c7 04 24 b7 40 00 00 	movl   $0x40b7,(%esp)
     751:	e8 44 32 00 00       	call   399a <unlink>
     756:	83 c4 10             	add    $0x10,%esp
     759:	89 c2                	mov    %eax,%edx
    printf(stdout, "unlink big failed\n");
     75b:	a1 1c 5f 00 00       	mov    0x5f1c,%eax
  if(unlink("big") < 0){
     760:	85 d2                	test   %edx,%edx
     762:	0f 88 aa 00 00 00    	js     812 <writetest1+0x1b2>
  printf(stdout, "big files ok\n");
     768:	83 ec 08             	sub    $0x8,%esp
     76b:	68 de 40 00 00       	push   $0x40de
     770:	50                   	push   %eax
     771:	e8 4a 33 00 00       	call   3ac0 <printf>
}
     ...
     783:	53                   	push   %ebx
     784:	68 67 40 00 00       	push   $0x4067
     789:	ff 35 1c 5f 00 00    	push   0x5f1c
     78f:	e8 2c 33 00 00       	call   3ac0 <printf>
      exit();
     794:	e8 81 31 00 00       	call   391a <exit>
      printf(stdout, "read content of block %d is %d\n",
     799:	50                   	push   %eax
     79a:	56                   	push   %esi
     79b:	68 bc 4e 00 00       	push   $0x4ebc
     7a0:	ff 35 1c 5f 00 00    	push   0x5f1c
     7a6:	e8 15 33 00 00       	call   3ac0 <printf>
      exit();
     7ab:	e8 6a 31 00 00       	call   391a <exit>
      printf(stdout, "read failed %d\n", i);
     7b0:	83 ec 04             	sub    $0x4,%esp
     7b3:	50                   	push   %eax
     7b4:	68 bb 40 00 00       	push   $0x40bb
     7b9:	ff 35 1c 5f 00 00    	push   0x5f1c
     7bf:	e8 fc 32 00 00       	call   3ac0 <printf>
      exit();
     7c4:	e8 51 31 00 00       	call   391a <exit>
        printf(stdout, "read only %d blocks from big", n);
     7c9:	51                   	push   %ecx
     7ca:	68 8b 00 00 00       	push   $0x8b
     7cf:	68 9e 40 00 00       	push   $0x409e
     7d4:	ff 35 1c 5f 00 00    	push   0x5f1c
     7da:	e8 e1 32 00 00       	call   3ac0 <printf>
        exit();
     7df:	e8 36 31 00 00       	call   391a <exit>
    printf(stdout, "error: open big failed!\n");
     7e4:	53                   	push   %ebx
     7e5:	53                   	push   %ebx
     7e6:	68 85 40 00 00       	push   $0x4085
     7eb:	ff 35 1c 5f 00 00    	push   0x5f1c
     7f1:	e8 ca 32 00 00       	call   3ac0 <printf>
    exit();
     7f6:	e8 1f 31 00 00       	call   391a <exit>
    printf(stdout, "error: creat big failed!\n");
     7fb:	50                   	push   %eax
     7fc:	50                   	push   %eax
     7fd:	68 4d 40 00 00       	push   $0x404d
     802:	ff 35 1c 5f 00 00    	push   0x5f1c
     808:	e8 b3 32 00 00       	call   3ac0 <printf>
    exit();
     80d:	e8 08 31 00 00       	call   391a <exit>
    printf(stdout, "unlink big failed\n");
     812:	52                   	push   %edx
     813:	52                   	push   %edx
     814:	68 cb 40 00 00       	push   $0x40cb
     819:	50                   	push   %eax
     81a:	e8 a1 32 00 00       	call   3ac0 <printf>
    exit();
     81f:	e8 f6 30 00 00       	call   391a <exit>
     ...
     834:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     83c:	68 dc 4e 00 00       	push   $0x4edc
     841:	ff 35 1c 5f 00 00    	push   0x5f1c
     847:	e8 74 32 00 00       	call   3ac0 <printf>
  name[0] = 'a';
     84c:	c6 05 50 86 00 00 61 	movb   $0x61,0x8650
  name[2] = '\0';
     853:	83 c4 10             	add    $0x10,%esp
     856:	c6 05 52 86 00 00 00 	movb   $0x0,0x8652
  for(i = 0; i < 52; i++){
     85d:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open(name, O_CREATE|O_RDWR);
     860:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     863:	88 1d 51 86 00 00    	mov    %bl,0x8651
  for(i = 0; i < 52; i++){
     869:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     86c:	68 02 02 00 00       	push   $0x202
     871:	68 50 86 00 00       	push   $0x8650
     876:	e8 07 31 00 00       	call   3982 <open>
    close(fd);
     87b:	89 04 24             	mov    %eax,(%esp)
     87e:	e8 2f 31 00 00       	call   39b2 <close>
  for(i = 0; i < 52; i++){
     883:	83 c4 10             	add    $0x10,%esp
     886:	80 fb 64             	cmp    $0x64,%bl
     889:	75 d5                	jne    860 <createtest+0x30>
  name[0] = 'a';
     88b:	c6 05 50 86 00 00 61 	movb   $0x61,0x8650
  name[2] = '\0';
     892:	bb 30 00 00 00       	mov    $0x30,%ebx
     897:	c6 05 52 86 00 00 00 	movb   $0x0,0x8652
  for(i = 0; i < 52; i++){
     89e:	66 90                	xchg   %ax,%ax
    unlink(name);
     8a0:	83 ec 0c             	sub    $0xc,%esp
    name[1] = '0' + i;
     8a3:	88 1d 51 86 00 00    	mov    %bl,0x8651
  for(i = 0; i < 52; i++){
     8a9:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     8ac:	68 50 86 00 00       	push   $0x8650
     8b1:	e8 e4 30 00 00       	call   399a <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8c6:	ff 35 1c 5f 00 00    	push   0x5f1c
     8cc:	e8 ef 31 00 00       	call   3ac0 <printf>
}
...
000008e0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     8e6:	68 ec 40 00 00       	push   $0x40ec
     8eb:	ff 35 1c 5f 00 00    	push   0x5f1c
     8f1:	e8 ca 31 00 00       	call   3ac0 <printf>
  if(mkdir("dir0") < 0){
     8f6:	c7 04 24 f8 40 00 00 	movl   $0x40f8,(%esp)
     8fd:	e8 a8 30 00 00       	call   39aa <mkdir>
     902:	83 c4 10             	add    $0x10,%esp
     905:	85 c0                	test   %eax,%eax
     907:	78 5a                	js     963 <dirtest+0x83>
  if(chdir("dir0") < 0){
     909:	83 ec 0c             	sub    $0xc,%esp
     90c:	68 f8 40 00 00       	push   $0x40f8
  ...
  if(chdir("..") < 0){
     ...
     924:	68 9d 46 00 00       	push   $0x469d
  ...
  if(unlink("dir0") < 0){
     ...
     938:	68 f8 40 00 00       	push   $0x40f8
     93d:	e8 58 30 00 00       	call   399a <unlink>
     942:	83 c4 10             	add    $0x10,%esp
     945:	89 c2                	mov    %eax,%edx
    printf(stdout, "unlink dir0 failed\n");
     947:	a1 1c 5f 00 00       	mov    0x5f1c,%eax
  if(unlink("dir0") < 0){
     94c:	85 d2                	test   %edx,%edx
     94e:	78 2a                	js     97a <dirtest+0x9a>
  printf(stdout, "mkdir test ok\n");
     950:	83 ec 08             	sub    $0x8,%esp
     953:	68 35 41 00 00       	push   $0x4135
     958:	50                   	push   %eax
     959:	e8 62 31 00 00       	call   3ac0 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     963:	50                   	push   %eax
     964:	50                   	push   %eax
     965:	68 28 3e 00 00       	push   $0x3e28
     96a:	ff 35 1c 5f 00 00    	push   0x5f1c
     970:	e8 4b 31 00 00       	call   3ac0 <printf>
    exit();
     975:	e8 a0 2f 00 00       	call   391a <exit>
    printf(stdout, "unlink dir0 failed\n");
     97a:	52                   	push   %edx
     97b:	52                   	push   %edx
     97c:	68 21 41 00 00       	push   $0x4121
     981:	50                   	push   %eax
     982:	e8 39 31 00 00       	call   3ac0 <printf>
    exit();
     987:	e8 8e 2f 00 00       	call   391a <exit>
    printf(stdout, "chdir .. failed\n");
     98c:	51                   	push   %ecx
     98d:	51                   	push   %ecx
     98e:	68 10 41 00 00       	push   $0x4110
     993:	ff 35 1c 5f 00 00    	push   0x5f1c
     999:	e8 22 31 00 00       	call   3ac0 <printf>
    exit();
     99e:	e8 77 2f 00 00       	call   391a <exit>
    printf(stdout, "chdir dir0 failed\n");
     9a3:	50                   	push   %eax
     9a4:	50                   	push   %eax
     9a5:	68 fd 40 00 00       	push   $0x40fd
     9aa:	ff 35 1c 5f 00 00    	push   0x5f1c
     9b0:	e8 0b 31 00 00       	call   3ac0 <printf>
    exit();
     9b5:	e8 60 2f 00 00       	call   391a <exit>
...
000009c0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     9c6:	68 44 41 00 00       	push   $0x4144
     9cb:	ff 35 1c 5f 00 00    	push   0x5f1c
     9d1:	e8 ea 30 00 00       	call   3ac0 <printf>
  if(exec("echo", echoargv) < 0){
     9d6:	5a                   	pop    %edx
     9d7:	59                   	pop    %ecx
     9d8:	68 20 5f 00 00       	push   $0x5f20
     9dd:	68 0d 3f 00 00       	push   $0x3f0d
     9e2:	e8 5b 2f 00 00       	call   3942 <exec>
    ...
    printf(stdout, "exec echo failed\n");
     9f0:	50                   	push   %eax
     9f1:	50                   	push   %eax
     9f2:	68 4f 41 00 00       	push   $0x414f
     9f7:	ff 35 1c 5f 00 00    	push   0x5f1c
     9fd:	e8 be 30 00 00       	call   3ac0 <printf>
    exit();
     a02:	e8 13 2f 00 00       	call   391a <exit>
     ...
     a15:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a4d:	e8 60 2f 00 00       	call   39b2 <close>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a5f:	56                   	push   %esi
     a60:	68 60 86 00 00       	push   $0x8660
     a65:	ff 75 e0             	push   -0x20(%ebp)
     a68:	e8 c5 2e 00 00       	call   3932 <read>
     ...
     a85:	38 90 60 86 00 00    	cmp    %dl,0x8660(%eax)
     ...
     aa8:	68 7e 41 00 00       	push   $0x417e
     aad:	6a 01                	push   $0x1
     aaf:	e8 0c 30 00 00       	call   3ac0 <printf>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ac7:	e8 e6 2e 00 00       	call   39b2 <close>
     ...
     ae3:	83 c0 01             	add    $0x1,%eax
        buf[i] = seq++;
     ae6:	88 90 5f 86 00 00    	mov    %dl,0x865f(%eax)
      for(i = 0; i < 1033; i++)
     ...
     b01:	68 60 86 00 00       	push   $0x8660
     b06:	ff 75 e4             	push   -0x1c(%ebp)
     b09:	e8 7c 2e 00 00       	call   398a <write>
    ...
    exit();
     b20:	e8 f5 2d 00 00       	call   391a <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b34:	e8 79 2e 00 00       	call   39b2 <close>
    wait();
     b39:	e8 e4 2d 00 00       	call   3922 <wait>
  printf(1, "pipe1 ok\n");
     b3e:	5a                   	pop    %edx
     b3f:	59                   	pop    %ecx
     b40:	68 a3 41 00 00       	push   $0x41a3
     b45:	6a 01                	push   $0x1
     b47:	e8 74 2f 00 00       	call   3ac0 <printf>
     b4c:	83 c4 10             	add    $0x10,%esp
     b4f:	e9 63 ff ff ff       	jmp    ab7 <pipe1+0xa7>
      printf(1, "pipe1 oops 3 total %d\n", total);
     b54:	53                   	push   %ebx
     b55:	ff 75 d4             	push   -0x2c(%ebp)
     b58:	68 8c 41 00 00       	push   $0x418c
     b5d:	6a 01                	push   $0x1
     b5f:	e8 5c 2f 00 00       	call   3ac0 <printf>
      exit();
     b64:	e8 b1 2d 00 00       	call   391a <exit>
    printf(1, "pipe() failed\n");
     b69:	57                   	push   %edi
     b6a:	57                   	push   %edi
     b6b:	68 61 41 00 00       	push   $0x4161
     b70:	6a 01                	push   $0x1
     b72:	e8 49 2f 00 00       	call   3ac0 <printf>
    exit();
     b77:	e8 9e 2d 00 00       	call   391a <exit>
    printf(1, "fork() failed\n");
     b7c:	50                   	push   %eax
     b7d:	50                   	push   %eax
     b7e:	68 ad 41 00 00       	push   $0x41ad
     b83:	6a 01                	push   $0x1
     b85:	e8 36 2f 00 00       	call   3ac0 <printf>
    exit();
     b8a:	e8 8b 2d 00 00       	call   391a <exit>
        printf(1, "pipe1 oops 1\n");
     b8f:	56                   	push   %esi
     b90:	56                   	push   %esi
     b91:	68 70 41 00 00       	push   $0x4170
     b96:	6a 01                	push   $0x1
     b98:	e8 23 2f 00 00       	call   3ac0 <printf>
        exit();
     b9d:	e8 78 2d 00 00       	call   391a <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 48 2d 00 00       	call   3912 <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 33 2d 00 00       	call   3912 <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 2e 2d 00 00       	call   392a <pipe>
  pid3 = fork();
     bfc:	e8 11 2d 00 00       	call   3912 <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 74 2d 00 00       	call   39b2 <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 37 2d 00 00       	call   39b2 <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 a9 2c 00 00       	call   393a <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 a1 2c 00 00       	call   393a <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 99 2c 00 00       	call   393a <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
  ...
  wait();
     caf:	e8 6e 2c 00 00       	call   3922 <wait>
  wait();
     cb4:	e8 69 2c 00 00       	call   3922 <wait>
  wait();
     cb9:	e8 64 2c 00 00       	call   3922 <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 fb 2b 00 00       	call   3922 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 dd 2b 00 00       	call   3912 <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret
      exit();
     d8a:	e8 8b 2b 00 00       	call   391a <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 b7 2b 00 00       	call   3962 <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 60 2b 00 00       	call   3912 <fork>
    ...
    exit();
     e1f:	e8 f6 2a 00 00       	call   391a <exit>
     ...
     e3a:	e8 fb 2a 00 00       	call   393a <kill>
      exit();
     e3f:	e8 d6 2a 00 00       	call   391a <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 cf 2a 00 00       	jmp    3922 <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 19 2b 00 00       	call   399a <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 63 42 00 00       	push   $0x4263
     e8d:	e8 f0 2a 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 66 2a 00 00       	call   3912 <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 17 2a 00 00       	call   3922 <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 99 2a 00 00       	call   39b2 <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 63 42 00 00       	push   $0x4263
     f22:	e8 5b 2a 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 e1 29 00 00       	call   3932 <read>
  ...
  close(fd);
     ...
     f86:	e8 27 2a 00 00       	call   39b2 <close>
  unlink("sharedfd");
     f8b:	c7 04 24 63 42 00 00 	movl   $0x4263,(%esp)
     f92:	e8 03 2a 00 00       	call   399a <unlink>
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fca:	68 30 4f 00 00       	push   $0x4f30
     fcf:	6a 01                	push   $0x1
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fe4:	68 7c 4f 00 00       	push   $0x4f7c
     fe9:	6a 01                	push   $0x1
    ...
    return;
     ...
     ffa:	c3                   	ret
    exit();
     ffb:	e8 1a 29 00 00       	call   391a <exit>
    ...
    exit();
    100e:	e8 07 29 00 00       	call   391a <exit>
    ...
    1026:	31 db                	xor    %ebx,%ebx
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    102b:	c7 45 d8 8e 42 00 00 	movl   $0x428e,-0x28(%ebp)
    1032:	c7 45 dc d7 43 00 00 	movl   $0x43d7,-0x24(%ebp)
    1039:	c7 45 e0 db 43 00 00 	movl   $0x43db,-0x20(%ebp)
    1040:	c7 45 e4 91 42 00 00 	movl   $0x4291,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
    1047:	68 94 42 00 00       	push   $0x4294
    104c:	6a 01                	push   $0x1
    104e:	e8 6d 2a 00 00       	call   3ac0 <printf>
    ...
    105d:	56                   	push   %esi
    105e:	e8 37 29 00 00       	call   399a <unlink>
    pid = fork();
    1063:	e8 aa 28 00 00       	call   3912 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1081:	e8 9c 28 00 00       	call   3922 <wait>
    1086:	e8 97 28 00 00       	call   3922 <wait>
    108b:	e8 92 28 00 00       	call   3922 <wait>
    1090:	e8 8d 28 00 00       	call   3922 <wait>
  for(i = 0; i < 2; i++){
    ...
    10ae:	6a 00                	push   $0x0
    10b0:	50                   	push   %eax
    10b1:	e8 cc 28 00 00       	call   3982 <open>
        if(buf[j] != '0'+i){
    ...
    10cd:	57                   	push   %edi
    10ce:	e8 5f 28 00 00       	call   3932 <read>
    ...
    10dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        if(buf[j] != '0'+i){
    10e0:	0f be 8a 60 86 00 00 	movsbl 0x8660(%edx),%ecx
    ...
    10f9:	57                   	push   %edi
    10fa:	e8 b3 28 00 00       	call   39b2 <close>
    if(total != 12*500){
    ...
    1114:	e8 81 28 00 00       	call   399a <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1135:	68 d2 42 00 00       	push   $0x42d2
    113a:	6a 01                	push   $0x1
    113c:	e8 7f 29 00 00       	call   3ac0 <printf>
}
    ...
    114f:	68 b5 42 00 00       	push   $0x42b5
    1154:	6a 01                	push   $0x1
    1156:	e8 65 29 00 00       	call   3ac0 <printf>
          exit();
    115b:	e8 ba 27 00 00       	call   391a <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1160:	83 ec 08             	sub    $0x8,%esp
    1163:	68 02 02 00 00       	push   $0x202
    1168:	56                   	push   %esi
    1169:	e8 14 28 00 00       	call   3982 <open>
      if(fd < 0){
    ...
    1188:	68 60 86 00 00       	push   $0x8660
    ...
    11a2:	56                   	push   %esi
    11a3:	e8 e2 27 00 00       	call   398a <write>
    ...
    11b5:	75 de                	jne    1195 <fourfiles+0x175>
      exit();
    11b7:	e8 5e 27 00 00       	call   391a <exit>
        printf(1, "create failed\n");
    11bc:	51                   	push   %ecx
    11bd:	51                   	push   %ecx
    11be:	68 2f 45 00 00       	push   $0x452f
    11c3:	6a 01                	push   $0x1
    11c5:	e8 f6 28 00 00       	call   3ac0 <printf>
        exit();
    11ca:	e8 4b 27 00 00       	call   391a <exit>
    11cf:	90                   	nop
      printf(1, "fork failed\n");
    11d0:	83 ec 08             	sub    $0x8,%esp
    11d3:	68 69 4d 00 00       	push   $0x4d69
    11d8:	6a 01                	push   $0x1
    11da:	e8 e1 28 00 00       	call   3ac0 <printf>
      exit();
    11df:	e8 36 27 00 00       	call   391a <exit>
      printf(1, "wrong length %d\n", total);
    11e4:	50                   	push   %eax
    11e5:	53                   	push   %ebx
    11e6:	68 c1 42 00 00       	push   $0x42c1
    11eb:	6a 01                	push   $0x1
    11ed:	e8 ce 28 00 00       	call   3ac0 <printf>
      exit();
    11f2:	e8 23 27 00 00       	call   391a <exit>
          printf(1, "write failed %d\n", n);
    11f7:	52                   	push   %edx
    11f8:	50                   	push   %eax
    11f9:	68 a4 42 00 00       	push   $0x42a4
    11fe:	6a 01                	push   $0x1
    1200:	e8 bb 28 00 00       	call   3ac0 <printf>
          exit();
    1205:	e8 10 27 00 00       	call   391a <exit>
    ...
    1215:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "createdelete test\n");
    121b:	68 e0 42 00 00       	push   $0x42e0
    1220:	6a 01                	push   $0x1
    1222:	e8 99 28 00 00       	call   3ac0 <printf>
    1227:	83 c4 10             	add    $0x10,%esp
    pid = fork();
    122a:	e8 e3 26 00 00       	call   3912 <fork>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1247:	e8 d6 26 00 00       	call   3922 <wait>
  for(i = 0; i < N; i++){
    124c:	31 ff                	xor    %edi,%edi
    124e:	8d 75 c8             	lea    -0x38(%ebp),%esi
    wait();
    1251:	e8 cc 26 00 00       	call   3922 <wait>
    1256:	e8 c7 26 00 00       	call   3922 <wait>
    125b:	e8 c2 26 00 00       	call   3922 <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    1298:	6a 00                	push   $0x0
    129a:	56                   	push   %esi
    129b:	e8 e2 26 00 00       	call   3982 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12b8:	50                   	push   %eax
    12b9:	e8 f4 26 00 00       	call   39b2 <close>
  ...
  for(i = 0; i < N; i++){
    ...
    12f7:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    12fa:	56                   	push   %esi
    12fb:	e8 9a 26 00 00       	call   399a <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    1314:	68 f3 42 00 00       	push   $0x42f3
    1319:	6a 01                	push   $0x1
    131b:	e8 a0 27 00 00       	call   3ac0 <printf>
}
    ...
    1334:	50                   	push   %eax
    1335:	56                   	push   %esi
    1336:	68 cc 4f 00 00       	push   $0x4fcc
    133b:	6a 01                	push   $0x1
    133d:	e8 7e 27 00 00       	call   3ac0 <printf>
        exit();
    1342:	e8 d3 25 00 00       	call   391a <exit>
    ...
    136e:	56                   	push   %esi
    136f:	e8 0e 26 00 00       	call   3982 <open>
        if(fd < 0){
    ...
    1382:	50                   	push   %eax
    1383:	e8 2a 26 00 00       	call   39b2 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    139a:	75 c4                	jne    1360 <createdelete+0x150>
      exit();
    139c:	e8 79 25 00 00       	call   391a <exit>
    ...
    13b9:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13bc:	56                   	push   %esi
    13bd:	e8 d8 25 00 00       	call   399a <unlink>
    ...
    13d1:	56                   	push   %esi
    13d2:	68 a8 4f 00 00       	push   $0x4fa8
    13d7:	6a 01                	push   $0x1
    13d9:	e8 e2 26 00 00       	call   3ac0 <printf>
        exit();
    13de:	e8 37 25 00 00       	call   391a <exit>
      printf(1, "fork failed\n");
    13e3:	83 ec 08             	sub    $0x8,%esp
    13e6:	68 69 4d 00 00       	push   $0x4d69
    13eb:	6a 01                	push   $0x1
    13ed:	e8 ce 26 00 00       	call   3ac0 <printf>
      exit();
    13f2:	e8 23 25 00 00       	call   391a <exit>
            printf(1, "unlink failed\n");
    13f7:	52                   	push   %edx
    13f8:	52                   	push   %edx
    13f9:	68 e1 3e 00 00       	push   $0x3ee1
    13fe:	6a 01                	push   $0x1
    1400:	e8 bb 26 00 00       	call   3ac0 <printf>
            exit();
    1405:	e8 10 25 00 00       	call   391a <exit>
          printf(1, "create failed\n");
    140a:	83 ec 08             	sub    $0x8,%esp
    140d:	68 2f 45 00 00       	push   $0x452f
    1412:	6a 01                	push   $0x1
    1414:	e8 a7 26 00 00       	call   3ac0 <printf>
          exit();
    1419:	e8 fc 24 00 00       	call   391a <exit>
...
00001420 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1428:	68 04 43 00 00       	push   $0x4304
    142d:	6a 01                	push   $0x1
    142f:	e8 8c 26 00 00       	call   3ac0 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1434:	5b                   	pop    %ebx
    1435:	5e                   	pop    %esi
    1436:	68 02 02 00 00       	push   $0x202
    143b:	68 15 43 00 00       	push   $0x4315
    1440:	e8 3d 25 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    1455:	6a 05                	push   $0x5
    1457:	68 3a 43 00 00       	push   $0x433a
    145c:	50                   	push   %eax
    145d:	e8 28 25 00 00       	call   398a <write>
  close(fd);
    1462:	89 1c 24             	mov    %ebx,(%esp)
    1465:	e8 48 25 00 00       	call   39b2 <close>
  fd = open("unlinkread", O_RDWR);
    146a:	58                   	pop    %eax
    146b:	5a                   	pop    %edx
    146c:	6a 02                	push   $0x2
    146e:	68 15 43 00 00       	push   $0x4315
    1473:	e8 0a 25 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    1488:	68 15 43 00 00       	push   $0x4315
    148d:	e8 08 25 00 00       	call   399a <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14a5:	68 15 43 00 00       	push   $0x4315
    14aa:	e8 d3 24 00 00       	call   3982 <open>
  write(fd1, "yyy", 3);
  ...
  write(fd1, "yyy", 3);
    14b6:	68 72 43 00 00       	push   $0x4372
    14bb:	50                   	push   %eax
    14bc:	e8 c9 24 00 00       	call   398a <write>
  close(fd1);
    14c1:	89 34 24             	mov    %esi,(%esp)
    14c4:	e8 e9 24 00 00       	call   39b2 <close>
  if(read(fd, buf, sizeof(buf)) != 5){
    14c9:	83 c4 0c             	add    $0xc,%esp
    14cc:	68 00 20 00 00       	push   $0x2000
    14d1:	68 60 86 00 00       	push   $0x8660
    14d6:	53                   	push   %ebx
    14d7:	e8 56 24 00 00       	call   3932 <read>
    14dc:	83 c4 10             	add    $0x10,%esp
    14df:	83 f8 05             	cmp    $0x5,%eax
    14e2:	0f 85 87 00 00 00    	jne    156f <unlinkread+0x14f>
  if(buf[0] != 'h'){
    14e8:	80 3d 60 86 00 00 68 	cmpb   $0x68,0x8660
    14ef:	75 6b                	jne    155c <unlinkread+0x13c>
  if(write(fd, buf, 10) != 10){
    14f1:	83 ec 04             	sub    $0x4,%esp
    14f4:	6a 0a                	push   $0xa
    14f6:	68 60 86 00 00       	push   $0x8660
    14fb:	53                   	push   %ebx
    14fc:	e8 89 24 00 00       	call   398a <write>
  ...
  close(fd);
    ...
    150c:	53                   	push   %ebx
    150d:	e8 a0 24 00 00       	call   39b2 <close>
  unlink("unlinkread");
    1512:	c7 04 24 15 43 00 00 	movl   $0x4315,(%esp)
    1519:	e8 7c 24 00 00       	call   399a <unlink>
  printf(1, "unlinkread ok\n");
    151e:	58                   	pop    %eax
    151f:	5a                   	pop    %edx
    1520:	68 bd 43 00 00       	push   $0x43bd
    1525:	6a 01                	push   $0x1
    1527:	e8 94 25 00 00       	call   3ac0 <printf>
}
    ...
    1536:	51                   	push   %ecx
    1537:	51                   	push   %ecx
    1538:	68 20 43 00 00       	push   $0x4320
    153d:	6a 01                	push   $0x1
    153f:	e8 7c 25 00 00       	call   3ac0 <printf>
    exit();
    1544:	e8 d1 23 00 00       	call   391a <exit>
    printf(1, "unlinkread write failed\n");
    1549:	51                   	push   %ecx
    154a:	51                   	push   %ecx
    154b:	68 a4 43 00 00       	push   $0x43a4
    1550:	6a 01                	push   $0x1
    1552:	e8 69 25 00 00       	call   3ac0 <printf>
    exit();
    1557:	e8 be 23 00 00       	call   391a <exit>
    printf(1, "unlinkread wrong data\n");
    155c:	53                   	push   %ebx
    155d:	53                   	push   %ebx
    155e:	68 8d 43 00 00       	push   $0x438d
    1563:	6a 01                	push   $0x1
    1565:	e8 56 25 00 00       	call   3ac0 <printf>
    exit();
    156a:	e8 ab 23 00 00       	call   391a <exit>
    printf(1, "unlinkread read failed");
    156f:	56                   	push   %esi
    1570:	56                   	push   %esi
    1571:	68 76 43 00 00       	push   $0x4376
    1576:	6a 01                	push   $0x1
    1578:	e8 43 25 00 00       	call   3ac0 <printf>
    exit();
    157d:	e8 98 23 00 00       	call   391a <exit>
    printf(1, "unlink unlinkread failed\n");
    1582:	50                   	push   %eax
    1583:	50                   	push   %eax
    1584:	68 58 43 00 00       	push   $0x4358
    1589:	6a 01                	push   $0x1
    158b:	e8 30 25 00 00       	call   3ac0 <printf>
    exit();
    1590:	e8 85 23 00 00       	call   391a <exit>
    printf(1, "open unlinkread failed\n");
    1595:	50                   	push   %eax
    1596:	50                   	push   %eax
    1597:	68 40 43 00 00       	push   $0x4340
    159c:	6a 01                	push   $0x1
    159e:	e8 1d 25 00 00       	call   3ac0 <printf>
    exit();
    15a3:	e8 72 23 00 00       	call   391a <exit>
...
000015b0 <linktest>:
{
  ...
  printf(1, "linktest\n");
    15b7:	68 cc 43 00 00       	push   $0x43cc
    15bc:	6a 01                	push   $0x1
    15be:	e8 fd 24 00 00       	call   3ac0 <printf>
  unlink("lf1");
    15c3:	c7 04 24 d6 43 00 00 	movl   $0x43d6,(%esp)
    15ca:	e8 cb 23 00 00       	call   399a <unlink>
  unlink("lf2");
    15cf:	c7 04 24 da 43 00 00 	movl   $0x43da,(%esp)
    15d6:	e8 bf 23 00 00       	call   399a <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    15db:	58                   	pop    %eax
    15dc:	5a                   	pop    %edx
    15dd:	68 02 02 00 00       	push   $0x202
    15e2:	68 d6 43 00 00       	push   $0x43d6
    15e7:	e8 96 23 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    15fc:	6a 05                	push   $0x5
    15fe:	68 3a 43 00 00       	push   $0x433a
    1603:	50                   	push   %eax
    1604:	e8 81 23 00 00       	call   398a <write>
  ...
  close(fd);
    ...
    1618:	53                   	push   %ebx
    1619:	e8 94 23 00 00       	call   39b2 <close>
  if(link("lf1", "lf2") < 0){
    161e:	5b                   	pop    %ebx
    161f:	58                   	pop    %eax
    1620:	68 da 43 00 00       	push   $0x43da
    1625:	68 d6 43 00 00       	push   $0x43d6
    162a:	e8 73 23 00 00       	call   39a2 <link>
    162f:	83 c4 10             	add    $0x10,%esp
    1632:	85 c0                	test   %eax,%eax
    1634:	0f 88 60 01 00 00    	js     179a <linktest+0x1ea>
  unlink("lf1");
    163a:	83 ec 0c             	sub    $0xc,%esp
    163d:	68 d6 43 00 00       	push   $0x43d6
    1642:	e8 53 23 00 00       	call   399a <unlink>
  if(open("lf1", 0) >= 0){
    1647:	58                   	pop    %eax
    1648:	5a                   	pop    %edx
    1649:	6a 00                	push   $0x0
    164b:	68 d6 43 00 00       	push   $0x43d6
    1650:	e8 2d 23 00 00       	call   3982 <open>
  ...
  fd = open("lf2", 0);
    ...
    1663:	6a 00                	push   $0x0
    1665:	68 da 43 00 00       	push   $0x43da
    166a:	e8 13 23 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1684:	68 60 86 00 00       	push   $0x8660
    1689:	50                   	push   %eax
    168a:	e8 a3 22 00 00       	call   3932 <read>
  ...
  close(fd);
    ...
    169e:	53                   	push   %ebx
    169f:	e8 0e 23 00 00       	call   39b2 <close>
  if(link("lf2", "lf2") >= 0){
    16a4:	58                   	pop    %eax
    16a5:	5a                   	pop    %edx
    16a6:	68 da 43 00 00       	push   $0x43da
    16ab:	68 da 43 00 00       	push   $0x43da
    16b0:	e8 ed 22 00 00       	call   39a2 <link>
    16b5:	83 c4 10             	add    $0x10,%esp
    16b8:	85 c0                	test   %eax,%eax
    16ba:	0f 89 8e 00 00 00    	jns    174e <linktest+0x19e>
  unlink("lf2");
    16c0:	83 ec 0c             	sub    $0xc,%esp
    16c3:	68 da 43 00 00       	push   $0x43da
    16c8:	e8 cd 22 00 00       	call   399a <unlink>
  if(link("lf2", "lf1") >= 0){
    16cd:	59                   	pop    %ecx
    16ce:	5b                   	pop    %ebx
    16cf:	68 d6 43 00 00       	push   $0x43d6
    16d4:	68 da 43 00 00       	push   $0x43da
    16d9:	e8 c4 22 00 00       	call   39a2 <link>
    16de:	83 c4 10             	add    $0x10,%esp
    16e1:	85 c0                	test   %eax,%eax
    16e3:	79 56                	jns    173b <linktest+0x18b>
  if(link(".", "lf1") >= 0){
    16e5:	83 ec 08             	sub    $0x8,%esp
    16e8:	68 d6 43 00 00       	push   $0x43d6
    16ed:	68 9e 46 00 00       	push   $0x469e
    16f2:	e8 ab 22 00 00       	call   39a2 <link>
    16f7:	83 c4 10             	add    $0x10,%esp
    16fa:	85 c0                	test   %eax,%eax
    16fc:	79 2a                	jns    1728 <linktest+0x178>
  printf(1, "linktest ok\n");
    16fe:	83 ec 08             	sub    $0x8,%esp
    1701:	68 74 44 00 00       	push   $0x4474
    1706:	6a 01                	push   $0x1
    1708:	e8 b3 23 00 00       	call   3ac0 <printf>
}
    ...
    1715:	50                   	push   %eax
    1716:	50                   	push   %eax
    1717:	68 de 43 00 00       	push   $0x43de
    171c:	6a 01                	push   $0x1
    171e:	e8 9d 23 00 00       	call   3ac0 <printf>
    exit();
    1723:	e8 f2 21 00 00       	call   391a <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    1728:	50                   	push   %eax
    1729:	50                   	push   %eax
    172a:	68 58 44 00 00       	push   $0x4458
    172f:	6a 01                	push   $0x1
    1731:	e8 8a 23 00 00       	call   3ac0 <printf>
    exit();
    1736:	e8 df 21 00 00       	call   391a <exit>
    printf(1, "link non-existant succeeded! oops\n");
    173b:	52                   	push   %edx
    173c:	52                   	push   %edx
    173d:	68 14 50 00 00       	push   $0x5014
    1742:	6a 01                	push   $0x1
    1744:	e8 77 23 00 00       	call   3ac0 <printf>
    exit();
    1749:	e8 cc 21 00 00       	call   391a <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    174e:	50                   	push   %eax
    174f:	50                   	push   %eax
    1750:	68 3a 44 00 00       	push   $0x443a
    1755:	6a 01                	push   $0x1
    1757:	e8 64 23 00 00       	call   3ac0 <printf>
    exit();
    175c:	e8 b9 21 00 00       	call   391a <exit>
    printf(1, "read lf2 failed\n");
    1761:	51                   	push   %ecx
    1762:	51                   	push   %ecx
    1763:	68 29 44 00 00       	push   $0x4429
    1768:	6a 01                	push   $0x1
    176a:	e8 51 23 00 00       	call   3ac0 <printf>
    exit();
    176f:	e8 a6 21 00 00       	call   391a <exit>
    printf(1, "open lf2 failed\n");
    1774:	53                   	push   %ebx
    1775:	53                   	push   %ebx
    1776:	68 18 44 00 00       	push   $0x4418
    177b:	6a 01                	push   $0x1
    177d:	e8 3e 23 00 00       	call   3ac0 <printf>
    exit();
    1782:	e8 93 21 00 00       	call   391a <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    1787:	50                   	push   %eax
    1788:	50                   	push   %eax
    1789:	68 ec 4f 00 00       	push   $0x4fec
    178e:	6a 01                	push   $0x1
    1790:	e8 2b 23 00 00       	call   3ac0 <printf>
    exit();
    1795:	e8 80 21 00 00       	call   391a <exit>
    printf(1, "link lf1 lf2 failed\n");
    179a:	51                   	push   %ecx
    179b:	51                   	push   %ecx
    179c:	68 03 44 00 00       	push   $0x4403
    17a1:	6a 01                	push   $0x1
    17a3:	e8 18 23 00 00       	call   3ac0 <printf>
    exit();
    17a8:	e8 6d 21 00 00       	call   391a <exit>
    printf(1, "write lf1 failed\n");
    17ad:	50                   	push   %eax
    17ae:	50                   	push   %eax
    17af:	68 f1 43 00 00       	push   $0x43f1
    17b4:	6a 01                	push   $0x1
    17b6:	e8 05 23 00 00       	call   3ac0 <printf>
    exit();
    17bb:	e8 5a 21 00 00       	call   391a <exit>
    ...
    17c5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    17ce:	68 81 44 00 00       	push   $0x4481
    17d3:	6a 01                	push   $0x1
    17d5:	e8 e6 22 00 00       	call   3ac0 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1809:	53                   	push   %ebx
    180a:	e8 73 21 00 00       	call   3982 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1819:	83 c6 01             	add    $0x1,%esi
      close(fd);
    181c:	50                   	push   %eax
    181d:	e8 90 21 00 00       	call   39b2 <close>
    1822:	83 c4 10             	add    $0x10,%esp
      wait();
    1825:	e8 f8 20 00 00       	call   3922 <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    183c:	53                   	push   %ebx
    183d:	e8 58 21 00 00       	call   399a <unlink>
    pid = fork();
    1842:	e8 cb 20 00 00       	call   3912 <fork>
    if(pid && (i % 3) == 1){
    ...
    1868:	53                   	push   %ebx
    1869:	e8 14 21 00 00       	call   3982 <open>
      if(fd < 0){
    ...
    187c:	53                   	push   %ebx
    187d:	68 94 44 00 00       	push   $0x4494
    1882:	6a 01                	push   $0x1
    1884:	e8 37 22 00 00       	call   3ac0 <printf>
        exit();
    1889:	e8 8c 20 00 00       	call   391a <exit>
  ...
  for(i = 0; i < 40; i++){
    1893:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    1896:	53                   	push   %ebx
    1897:	68 91 44 00 00       	push   $0x4491
    189c:	e8 01 21 00 00       	call   39a2 <link>
    18a1:	83 c4 10             	add    $0x10,%esp
      wait();
    18a4:	e8 79 20 00 00       	call   3922 <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    18c3:	5f                   	pop    %edi
    18c4:	6a 00                	push   $0x0
    18c6:	68 9e 46 00 00       	push   $0x469e
    18cb:	8d 7d b0             	lea    -0x50(%ebp),%edi
    18ce:	e8 af 20 00 00       	call   3982 <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    18e5:	57                   	push   %edi
    18e6:	56                   	push   %esi
    18e7:	e8 46 20 00 00       	call   3932 <read>
    ...
    1933:	53                   	push   %ebx
    1934:	68 91 44 00 00       	push   $0x4491
    1939:	e8 64 20 00 00       	call   39a2 <link>
    193e:	83 c4 10             	add    $0x10,%esp
      exit();
    1941:	e8 d4 1f 00 00       	call   391a <exit>
  ...
  close(fd);
    ...
    1953:	56                   	push   %esi
    1954:	e8 59 20 00 00       	call   39b2 <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    197c:	53                   	push   %ebx
    197d:	e8 18 20 00 00       	call   399a <unlink>
      unlink(file);
    1982:	89 1c 24             	mov    %ebx,(%esp)
    1985:	e8 10 20 00 00       	call   399a <unlink>
      unlink(file);
    198a:	89 1c 24             	mov    %ebx,(%esp)
    198d:	e8 08 20 00 00       	call   399a <unlink>
      unlink(file);
    1992:	89 1c 24             	mov    %ebx,(%esp)
    1995:	e8 00 20 00 00       	call   399a <unlink>
    199a:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    199d:	85 ff                	test   %edi,%edi
    199f:	74 a0                	je     1941 <concreate+0x181>
      wait();
    19a1:	e8 7c 1f 00 00       	call   3922 <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19b8:	e8 55 1f 00 00       	call   3912 <fork>
    ...
    19e4:	6a 00                	push   $0x0
    19e6:	53                   	push   %ebx
    19e7:	e8 96 1f 00 00       	call   3982 <open>
    19ec:	89 04 24             	mov    %eax,(%esp)
    19ef:	e8 be 1f 00 00       	call   39b2 <close>
      close(open(file, 0));
    19f4:	58                   	pop    %eax
    19f5:	5a                   	pop    %edx
    19f6:	6a 00                	push   $0x0
    19f8:	53                   	push   %ebx
    19f9:	e8 84 1f 00 00       	call   3982 <open>
    19fe:	89 04 24             	mov    %eax,(%esp)
    1a01:	e8 ac 1f 00 00       	call   39b2 <close>
      close(open(file, 0));
    1a06:	59                   	pop    %ecx
    1a07:	58                   	pop    %eax
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 72 1f 00 00       	call   3982 <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 9a 1f 00 00       	call   39b2 <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 60 1f 00 00       	call   3982 <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 88 1f 00 00       	call   39b2 <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a3b:	68 e6 44 00 00       	push   $0x44e6
    1a40:	6a 01                	push   $0x1
    1a42:	e8 79 20 00 00       	call   3ac0 <printf>
}
    ...
    1a52:	68 69 4d 00 00       	push   $0x4d69
    1a57:	6a 01                	push   $0x1
    1a59:	e8 62 20 00 00       	call   3ac0 <printf>
      exit();
    1a5e:	e8 b7 1e 00 00       	call   391a <exit>
      close(fd);
    1a63:	83 ec 0c             	sub    $0xc,%esp
    1a66:	50                   	push   %eax
    1a67:	e8 46 1f 00 00       	call   39b2 <close>
    ...
    1a7a:	50                   	push   %eax
    1a7b:	68 b0 44 00 00       	push   $0x44b0
    1a80:	6a 01                	push   $0x1
    1a82:	e8 39 20 00 00       	call   3ac0 <printf>
        exit();
    1a87:	e8 8e 1e 00 00       	call   391a <exit>
    printf(1, "concreate not enough files in directory listing\n");
    1a8c:	51                   	push   %ecx
    1a8d:	51                   	push   %ecx
    1a8e:	68 38 50 00 00       	push   $0x5038
    1a93:	6a 01                	push   $0x1
    1a95:	e8 26 20 00 00       	call   3ac0 <printf>
    exit();
    1a9a:	e8 7b 1e 00 00       	call   391a <exit>
        printf(1, "concreate duplicate file %s\n", de.name);
    1a9f:	83 ec 04             	sub    $0x4,%esp
    1aa2:	8d 45 b2             	lea    -0x4e(%ebp),%eax
    1aa5:	50                   	push   %eax
    1aa6:	68 c9 44 00 00       	push   $0x44c9
    1aab:	6a 01                	push   $0x1
    1aad:	e8 0e 20 00 00       	call   3ac0 <printf>
        exit();
    1ab2:	e8 63 1e 00 00       	call   391a <exit>
...
00001ac0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1ac9:	68 f4 44 00 00       	push   $0x44f4
    1ace:	6a 01                	push   $0x1
    1ad0:	e8 eb 1f 00 00       	call   3ac0 <printf>
  unlink("x");
    1ad5:	c7 04 24 81 47 00 00 	movl   $0x4781,(%esp)
    1adc:	e8 b9 1e 00 00       	call   399a <unlink>
  pid = fork();
    1ae1:	e8 2c 1e 00 00       	call   3912 <fork>
  if(pid < 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    1b18:	68 81 47 00 00       	push   $0x4781
    1b1d:	e8 78 1e 00 00       	call   399a <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b51:	68 81 47 00 00       	push   $0x4781
    1b56:	e8 27 1e 00 00       	call   3982 <open>
    1b5b:	89 04 24             	mov    %eax,(%esp)
    1b5e:	e8 4f 1e 00 00       	call   39b2 <close>
  ...
  if(pid)
    ...
    wait();
    1b72:	e8 ab 1d 00 00       	call   3922 <wait>
  printf(1, "linkunlink ok\n");
    1b77:	83 ec 08             	sub    $0x8,%esp
    1b7a:	68 09 45 00 00       	push   $0x4509
    1b7f:	6a 01                	push   $0x1
    1b81:	e8 3a 1f 00 00       	call   3ac0 <printf>
}
    ...
    1b93:	68 81 47 00 00       	push   $0x4781
    1b98:	68 05 45 00 00       	push   $0x4505
    1b9d:	e8 00 1e 00 00       	call   39a2 <link>
    1ba2:	83 c4 10             	add    $0x10,%esp
    1ba5:	e9 7b ff ff ff       	jmp    1b25 <linkunlink+0x65>
    printf(1, "fork failed\n");
    1baa:	52                   	push   %edx
    1bab:	52                   	push   %edx
    1bac:	68 69 4d 00 00       	push   $0x4d69
    1bb1:	6a 01                	push   $0x1
    1bb3:	e8 08 1f 00 00       	call   3ac0 <printf>
    exit();
    1bb8:	e8 5d 1d 00 00       	call   391a <exit>
    exit();
    1bbd:	e8 58 1d 00 00       	call   391a <exit>
...
00001bd0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1bd9:	68 18 45 00 00       	push   $0x4518
    1bde:	6a 01                	push   $0x1
    1be0:	e8 db 1e 00 00       	call   3ac0 <printf>
  unlink("bd");
    1be5:	c7 04 24 25 45 00 00 	movl   $0x4525,(%esp)
    1bec:	e8 a9 1d 00 00       	call   399a <unlink>
  fd = open("bd", O_CREATE);
    1bf1:	5a                   	pop    %edx
    1bf2:	59                   	pop    %ecx
    1bf3:	68 00 02 00 00       	push   $0x200
    1bf8:	68 25 45 00 00       	push   $0x4525
    1bfd:	e8 80 1d 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  close(fd);
    1c15:	50                   	push   %eax
    1c16:	e8 97 1d 00 00       	call   39b2 <close>
    ...
    if(link("bd", name) != 0){
    1c41:	57                   	push   %edi
    1c42:	68 25 45 00 00       	push   $0x4525
    1c47:	e8 56 1d 00 00       	call   39a2 <link>
  ...
  unlink("bd");
    ...
    1c63:	68 25 45 00 00       	push   $0x4525
    1c68:	e8 2d 1d 00 00       	call   399a <unlink>
    ...
    if(unlink(name) != 0){
    1c91:	57                   	push   %edi
    1c92:	e8 03 1d 00 00       	call   399a <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1cac:	68 67 45 00 00       	push   $0x4567
    1cb1:	6a 01                	push   $0x1
    1cb3:	e8 08 1e 00 00       	call   3ac0 <printf>
    ...
    1cc6:	68 3e 45 00 00       	push   $0x453e
    1ccb:	6a 01                	push   $0x1
    1ccd:	e8 ee 1d 00 00       	call   3ac0 <printf>
      exit();
    1cd2:	e8 43 1c 00 00       	call   391a <exit>
      printf(1, "bigdir unlink failed");
    1cd7:	83 ec 08             	sub    $0x8,%esp
    1cda:	68 52 45 00 00       	push   $0x4552
    1cdf:	6a 01                	push   $0x1
    1ce1:	e8 da 1d 00 00       	call   3ac0 <printf>
      exit();
    1ce6:	e8 2f 1c 00 00       	call   391a <exit>
    printf(1, "bigdir create failed\n");
    1ceb:	50                   	push   %eax
    1cec:	50                   	push   %eax
    1ced:	68 28 45 00 00       	push   $0x4528
    1cf2:	6a 01                	push   $0x1
    1cf4:	e8 c7 1d 00 00       	call   3ac0 <printf>
    exit();
    1cf9:	e8 1c 1c 00 00       	call   391a <exit>
...
00001d00 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1d07:	68 72 45 00 00       	push   $0x4572
    1d0c:	6a 01                	push   $0x1
    1d0e:	e8 ad 1d 00 00       	call   3ac0 <printf>
  unlink("ff");
    1d13:	c7 04 24 fb 45 00 00 	movl   $0x45fb,(%esp)
    1d1a:	e8 7b 1c 00 00       	call   399a <unlink>
  if(mkdir("dd") != 0){
    1d1f:	c7 04 24 98 46 00 00 	movl   $0x4698,(%esp)
    1d26:	e8 7f 1c 00 00       	call   39aa <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d3e:	68 d1 45 00 00       	push   $0x45d1
    1d43:	e8 3a 1c 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d58:	6a 02                	push   $0x2
    1d5a:	68 fb 45 00 00       	push   $0x45fb
    1d5f:	50                   	push   %eax
    1d60:	e8 25 1c 00 00       	call   398a <write>
  close(fd);
    1d65:	89 1c 24             	mov    %ebx,(%esp)
    1d68:	e8 45 1c 00 00       	call   39b2 <close>
  if(unlink("dd") >= 0){
    1d6d:	c7 04 24 98 46 00 00 	movl   $0x4698,(%esp)
    1d74:	e8 21 1c 00 00       	call   399a <unlink>
    1d79:	83 c4 10             	add    $0x10,%esp
    1d7c:	85 c0                	test   %eax,%eax
    1d7e:	0f 89 3f 05 00 00    	jns    22c3 <subdir+0x5c3>
  if(mkdir("/dd/dd") != 0){
    1d84:	83 ec 0c             	sub    $0xc,%esp
    1d87:	68 ac 45 00 00       	push   $0x45ac
    1d8c:	e8 19 1c 00 00       	call   39aa <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1da4:	68 ce 45 00 00       	push   $0x45ce
    1da9:	e8 d4 1b 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1dbe:	6a 02                	push   $0x2
    1dc0:	68 ef 45 00 00       	push   $0x45ef
    1dc5:	50                   	push   %eax
    1dc6:	e8 bf 1b 00 00       	call   398a <write>
  close(fd);
    1dcb:	89 1c 24             	mov    %ebx,(%esp)
    1dce:	e8 df 1b 00 00       	call   39b2 <close>
  fd = open("dd/dd/../ff", 0);
    1dd3:	58                   	pop    %eax
    1dd4:	5a                   	pop    %edx
    1dd5:	6a 00                	push   $0x0
    1dd7:	68 f2 45 00 00       	push   $0x45f2
    1ddc:	e8 a1 1b 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1df6:	68 60 86 00 00       	push   $0x8660
    1dfb:	50                   	push   %eax
    1dfc:	e8 31 1b 00 00       	call   3932 <read>
  if(cc != 2 || buf[0] != 'f'){
    1e01:	83 c4 10             	add    $0x10,%esp
    1e04:	83 f8 02             	cmp    $0x2,%eax
    1e07:	0f 85 3a 03 00 00    	jne    2147 <subdir+0x447>
    1e0d:	80 3d 60 86 00 00 66 	cmpb   $0x66,0x8660
    1e14:	0f 85 2d 03 00 00    	jne    2147 <subdir+0x447>
  close(fd);
    1e1a:	83 ec 0c             	sub    $0xc,%esp
    1e1d:	53                   	push   %ebx
    1e1e:	e8 8f 1b 00 00       	call   39b2 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e23:	59                   	pop    %ecx
    1e24:	5b                   	pop    %ebx
    1e25:	68 32 46 00 00       	push   $0x4632
    1e2a:	68 ce 45 00 00       	push   $0x45ce
    1e2f:	e8 6e 1b 00 00       	call   39a2 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e42:	68 ce 45 00 00       	push   $0x45ce
    1e47:	e8 4e 1b 00 00       	call   399a <unlink>
  ...
  if(chdir("./..") != 0){
    ...
    1ebc:	68 9b 46 00 00       	push   $0x469b
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ed4:	6a 00                	push   $0x0
    1ed6:	68 32 46 00 00       	push   $0x4632
    1edb:	e8 a2 1a 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1ef5:	68 60 86 00 00       	push   $0x8660
    1efa:	50                   	push   %eax
    1efb:	e8 32 1a 00 00       	call   3932 <read>
  ...
  close(fd);
    ...
    1f0f:	53                   	push   %ebx
    1f10:	e8 9d 1a 00 00       	call   39b2 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f15:	58                   	pop    %eax
    1f16:	5a                   	pop    %edx
    1f17:	6a 00                	push   $0x0
    1f19:	68 ce 45 00 00       	push   $0x45ce
    1f1e:	e8 5f 1a 00 00       	call   3982 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f36:	68 e6 46 00 00       	push   $0x46e6
    1f3b:	e8 42 1a 00 00       	call   3982 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f53:	68 0b 47 00 00       	push   $0x470b
    1f58:	e8 25 1a 00 00       	call   3982 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f70:	68 98 46 00 00       	push   $0x4698
    1f75:	e8 08 1a 00 00       	call   3982 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f88:	6a 02                	push   $0x2
    1f8a:	68 98 46 00 00       	push   $0x4698
    1f8f:	e8 ee 19 00 00       	call   3982 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fa2:	6a 01                	push   $0x1
    1fa4:	68 98 46 00 00       	push   $0x4698
    1fa9:	e8 d4 19 00 00       	call   3982 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fbc:	68 7a 47 00 00       	push   $0x477a
    1fc1:	68 e6 46 00 00       	push   $0x46e6
    1fc6:	e8 d7 19 00 00       	call   39a2 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1fd9:	68 7a 47 00 00       	push   $0x477a
    1fde:	68 0b 47 00 00       	push   $0x470b
    1fe3:	e8 ba 19 00 00       	call   39a2 <link>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2043:	68 32 46 00 00       	push   $0x4632
    2048:	e8 5d 19 00 00       	call   39aa <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    205b:	68 0b 47 00 00       	push   $0x470b
    2060:	e8 35 19 00 00       	call   399a <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    2147:	50                   	push   %eax
    2148:	50                   	push   %eax
    2149:	68 17 46 00 00       	push   $0x4617
    214e:	6a 01                	push   $0x1
    2150:	e8 6b 19 00 00       	call   3ac0 <printf>
    exit();
    2155:	e8 c0 17 00 00       	call   391a <exit>
    printf(1, "chdir dd/../../dd failed\n");
    215a:	50                   	push   %eax
    215b:	50                   	push   %eax
    215c:	68 72 46 00 00       	push   $0x4672
    2161:	6a 01                	push   $0x1
    2163:	e8 58 19 00 00       	call   3ac0 <printf>
    exit();
    2168:	e8 ad 17 00 00       	call   391a <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    216d:	50                   	push   %eax
    216e:	50                   	push   %eax
    216f:	68 3d 46 00 00       	push   $0x463d
    2174:	6a 01                	push   $0x1
    2176:	e8 45 19 00 00       	call   3ac0 <printf>
    exit();
    217b:	e8 9a 17 00 00       	call   391a <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    2180:	51                   	push   %ecx
    2181:	51                   	push   %ecx
    2182:	68 ef 46 00 00       	push   $0x46ef
    2187:	6a 01                	push   $0x1
    2189:	e8 32 19 00 00       	call   3ac0 <printf>
    exit();
    218e:	e8 87 17 00 00       	call   391a <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2193:	53                   	push   %ebx
    2194:	53                   	push   %ebx
    2195:	68 dc 50 00 00       	push   $0x50dc
    219a:	6a 01                	push   $0x1
    219c:	e8 1f 19 00 00       	call   3ac0 <printf>
    exit();
    21a1:	e8 74 17 00 00       	call   391a <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    21a6:	51                   	push   %ecx
    21a7:	51                   	push   %ecx
    21a8:	68 83 47 00 00       	push   $0x4783
    21ad:	6a 01                	push   $0x1
    21af:	e8 0c 19 00 00       	call   3ac0 <printf>
    exit();
    21b4:	e8 61 17 00 00       	call   391a <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    21b9:	53                   	push   %ebx
    21ba:	53                   	push   %ebx
    21bb:	68 4c 51 00 00       	push   $0x514c
    21c0:	6a 01                	push   $0x1
    21c2:	e8 f9 18 00 00       	call   3ac0 <printf>
    exit();
    21c7:	e8 4e 17 00 00       	call   391a <exit>
    printf(1, "open dd/dd/../ff failed\n");
    21cc:	50                   	push   %eax
    21cd:	50                   	push   %eax
    21ce:	68 fe 45 00 00       	push   $0x45fe
    21d3:	6a 01                	push   $0x1
    21d5:	e8 e6 18 00 00       	call   3ac0 <printf>
    exit();
    21da:	e8 3b 17 00 00       	call   391a <exit>
    printf(1, "create dd/dd/ff failed\n");
    21df:	51                   	push   %ecx
    21e0:	51                   	push   %ecx
    21e1:	68 d7 45 00 00       	push   $0x45d7
    21e6:	6a 01                	push   $0x1
    21e8:	e8 d3 18 00 00       	call   3ac0 <printf>
    exit();
    21ed:	e8 28 17 00 00       	call   391a <exit>
    printf(1, "chdir ./.. failed\n");
    21f2:	50                   	push   %eax
    21f3:	50                   	push   %eax
    21f4:	68 a0 46 00 00       	push   $0x46a0
    21f9:	6a 01                	push   $0x1
    21fb:	e8 c0 18 00 00       	call   3ac0 <printf>
    exit();
    2200:	e8 15 17 00 00       	call   391a <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2205:	52                   	push   %edx
    2206:	52                   	push   %edx
    2207:	68 94 50 00 00       	push   $0x5094
    220c:	6a 01                	push   $0x1
    220e:	e8 ad 18 00 00       	call   3ac0 <printf>
    exit();
    2213:	e8 02 17 00 00       	call   391a <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2218:	50                   	push   %eax
    2219:	50                   	push   %eax
    221a:	68 28 51 00 00       	push   $0x5128
    221f:	6a 01                	push   $0x1
    2221:	e8 9a 18 00 00       	call   3ac0 <printf>
    exit();
    2226:	e8 ef 16 00 00       	call   391a <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    222b:	50                   	push   %eax
    222c:	50                   	push   %eax
    222d:	68 04 51 00 00       	push   $0x5104
    2232:	6a 01                	push   $0x1
    2234:	e8 87 18 00 00       	call   3ac0 <printf>
    exit();
    2239:	e8 dc 16 00 00       	call   391a <exit>
    printf(1, "open dd wronly succeeded!\n");
    223e:	50                   	push   %eax
    223f:	50                   	push   %eax
    2240:	68 5f 47 00 00       	push   $0x475f
    2245:	6a 01                	push   $0x1
    2247:	e8 74 18 00 00       	call   3ac0 <printf>
    exit();
    224c:	e8 c9 16 00 00       	call   391a <exit>
    printf(1, "open dd rdwr succeeded!\n");
    2251:	50                   	push   %eax
    2252:	50                   	push   %eax
    2253:	68 46 47 00 00       	push   $0x4746
    2258:	6a 01                	push   $0x1
    225a:	e8 61 18 00 00       	call   3ac0 <printf>
    exit();
    225f:	e8 b6 16 00 00       	call   391a <exit>
    printf(1, "create dd succeeded!\n");
    2264:	50                   	push   %eax
    2265:	50                   	push   %eax
    2266:	68 30 47 00 00       	push   $0x4730
    226b:	6a 01                	push   $0x1
    226d:	e8 4e 18 00 00       	call   3ac0 <printf>
    exit();
    2272:	e8 a3 16 00 00       	call   391a <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    2277:	52                   	push   %edx
    2278:	52                   	push   %edx
    2279:	68 14 47 00 00       	push   $0x4714
    227e:	6a 01                	push   $0x1
    2280:	e8 3b 18 00 00       	call   3ac0 <printf>
    exit();
    2285:	e8 90 16 00 00       	call   391a <exit>
    printf(1, "chdir dd failed\n");
    228a:	50                   	push   %eax
    228b:	50                   	push   %eax
    228c:	68 55 46 00 00       	push   $0x4655
    2291:	6a 01                	push   $0x1
    2293:	e8 28 18 00 00       	call   3ac0 <printf>
    exit();
    2298:	e8 7d 16 00 00       	call   391a <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    229d:	50                   	push   %eax
    229e:	50                   	push   %eax
    229f:	68 b8 50 00 00       	push   $0x50b8
    22a4:	6a 01                	push   $0x1
    22a6:	e8 15 18 00 00       	call   3ac0 <printf>
    exit();
    22ab:	e8 6a 16 00 00       	call   391a <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    22b0:	53                   	push   %ebx
    22b1:	53                   	push   %ebx
    22b2:	68 b3 45 00 00       	push   $0x45b3
    22b7:	6a 01                	push   $0x1
    22b9:	e8 02 18 00 00       	call   3ac0 <printf>
    exit();
    22be:	e8 57 16 00 00       	call   391a <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    22c3:	50                   	push   %eax
    22c4:	50                   	push   %eax
    22c5:	68 6c 50 00 00       	push   $0x506c
    22ca:	6a 01                	push   $0x1
    22cc:	e8 ef 17 00 00       	call   3ac0 <printf>
    exit();
    22d1:	e8 44 16 00 00       	call   391a <exit>
    printf(1, "create dd/ff failed\n");
    22d6:	50                   	push   %eax
    22d7:	50                   	push   %eax
    22d8:	68 97 45 00 00       	push   $0x4597
    22dd:	6a 01                	push   $0x1
    22df:	e8 dc 17 00 00       	call   3ac0 <printf>
    exit();
    22e4:	e8 31 16 00 00       	call   391a <exit>
    printf(1, "subdir mkdir dd failed\n");
    22e9:	50                   	push   %eax
    22ea:	50                   	push   %eax
    22eb:	68 7f 45 00 00       	push   $0x457f
    22f0:	6a 01                	push   $0x1
    22f2:	e8 c9 17 00 00       	call   3ac0 <printf>
    exit();
    22f7:	e8 1e 16 00 00       	call   391a <exit>
    printf(1, "unlink dd failed\n");
    22fc:	50                   	push   %eax
    22fd:	50                   	push   %eax
    22fe:	68 68 48 00 00       	push   $0x4868
    2303:	6a 01                	push   $0x1
    2305:	e8 b6 17 00 00       	call   3ac0 <printf>
    exit();
    230a:	e8 0b 16 00 00       	call   391a <exit>
    printf(1, "unlink dd/dd failed\n");
    230f:	52                   	push   %edx
    2310:	52                   	push   %edx
    2311:	68 53 48 00 00       	push   $0x4853
    2316:	6a 01                	push   $0x1
    2318:	e8 a3 17 00 00       	call   3ac0 <printf>
    exit();
    231d:	e8 f8 15 00 00       	call   391a <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    2322:	51                   	push   %ecx
    2323:	51                   	push   %ecx
    2324:	68 70 51 00 00       	push   $0x5170
    2329:	6a 01                	push   $0x1
    232b:	e8 90 17 00 00       	call   3ac0 <printf>
    exit();
    2330:	e8 e5 15 00 00       	call   391a <exit>
    printf(1, "unlink dd/ff failed\n");
    2335:	53                   	push   %ebx
    2336:	53                   	push   %ebx
    2337:	68 3e 48 00 00       	push   $0x483e
    233c:	6a 01                	push   $0x1
    233e:	e8 7d 17 00 00       	call   3ac0 <printf>
    exit();
    2343:	e8 d2 15 00 00       	call   391a <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    2348:	50                   	push   %eax
    2349:	50                   	push   %eax
    234a:	68 26 48 00 00       	push   $0x4826
    234f:	6a 01                	push   $0x1
    2351:	e8 6a 17 00 00       	call   3ac0 <printf>
    exit();
    2356:	e8 bf 15 00 00       	call   391a <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    235b:	50                   	push   %eax
    235c:	50                   	push   %eax
    235d:	68 0e 48 00 00       	push   $0x480e
    2362:	6a 01                	push   $0x1
    2364:	e8 57 17 00 00       	call   3ac0 <printf>
    exit();
    2369:	e8 ac 15 00 00       	call   391a <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    236e:	50                   	push   %eax
    236f:	50                   	push   %eax
    2370:	68 f2 47 00 00       	push   $0x47f2
    2375:	6a 01                	push   $0x1
    2377:	e8 44 17 00 00       	call   3ac0 <printf>
    exit();
    237c:	e8 99 15 00 00       	call   391a <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2381:	50                   	push   %eax
    2382:	50                   	push   %eax
    2383:	68 d6 47 00 00       	push   $0x47d6
    2388:	6a 01                	push   $0x1
    238a:	e8 31 17 00 00       	call   3ac0 <printf>
    exit();
    238f:	e8 86 15 00 00       	call   391a <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    2394:	50                   	push   %eax
    2395:	50                   	push   %eax
    2396:	68 b9 47 00 00       	push   $0x47b9
    239b:	6a 01                	push   $0x1
    239d:	e8 1e 17 00 00       	call   3ac0 <printf>
    exit();
    23a2:	e8 73 15 00 00       	call   391a <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    23a7:	52                   	push   %edx
    23a8:	52                   	push   %edx
    23a9:	68 9e 47 00 00       	push   $0x479e
    23ae:	6a 01                	push   $0x1
    23b0:	e8 0b 17 00 00       	call   3ac0 <printf>
    exit();
    23b5:	e8 60 15 00 00       	call   391a <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    23ba:	51                   	push   %ecx
    23bb:	51                   	push   %ecx
    23bc:	68 cb 46 00 00       	push   $0x46cb
    23c1:	6a 01                	push   $0x1
    23c3:	e8 f8 16 00 00       	call   3ac0 <printf>
    exit();
    23c8:	e8 4d 15 00 00       	call   391a <exit>
    printf(1, "open dd/dd/ffff failed\n");
    23cd:	53                   	push   %ebx
    23ce:	53                   	push   %ebx
    23cf:	68 b3 46 00 00       	push   $0x46b3
    23d4:	6a 01                	push   $0x1
    23d6:	e8 e5 16 00 00       	call   3ac0 <printf>
    exit();
    23db:	e8 3a 15 00 00       	call   391a <exit>
...
000023e0 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    23ed:	68 85 48 00 00       	push   $0x4885
    23f2:	6a 01                	push   $0x1
    23f4:	e8 c7 16 00 00       	call   3ac0 <printf>
  unlink("bigwrite");
    23f9:	c7 04 24 94 48 00 00 	movl   $0x4894,(%esp)
    2400:	e8 95 15 00 00       	call   399a <unlink>
    ...
    2418:	68 94 48 00 00       	push   $0x4894
    241d:	e8 60 15 00 00       	call   3982 <open>
    if(fd < 0){
    ...
    242e:	53                   	push   %ebx
    242f:	68 60 86 00 00       	push   $0x8660
    2434:	50                   	push   %eax
    2435:	e8 50 15 00 00       	call   398a <write>
      if(cc != sz){
    ...
    2444:	53                   	push   %ebx
    2445:	68 60 86 00 00       	push   $0x8660
    244a:	56                   	push   %esi
    244b:	e8 3a 15 00 00       	call   398a <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2460:	56                   	push   %esi
    2461:	e8 4c 15 00 00       	call   39b2 <close>
    unlink("bigwrite");
    2466:	c7 04 24 94 48 00 00 	movl   $0x4894,(%esp)
    246d:	e8 28 15 00 00       	call   399a <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    2480:	68 c7 48 00 00       	push   $0x48c7
    2485:	6a 01                	push   $0x1
    2487:	e8 34 16 00 00       	call   3ac0 <printf>
}
    ...
    2496:	50                   	push   %eax
    2497:	53                   	push   %ebx
    2498:	68 b5 48 00 00       	push   $0x48b5
    249d:	6a 01                	push   $0x1
    249f:	e8 1c 16 00 00       	call   3ac0 <printf>
        exit();
    24a4:	e8 71 14 00 00       	call   391a <exit>
      printf(1, "cannot create bigwrite\n");
    24a9:	83 ec 08             	sub    $0x8,%esp
    24ac:	68 9d 48 00 00       	push   $0x489d
    24b1:	6a 01                	push   $0x1
    24b3:	e8 08 16 00 00       	call   3ac0 <printf>
      exit();
    24b8:	e8 5d 14 00 00       	call   391a <exit>
...
000024c0 <bigfile>:
{
  ...
  printf(1, "bigfile test\n");
    24c9:	68 d4 48 00 00       	push   $0x48d4
    24ce:	6a 01                	push   $0x1
    24d0:	e8 eb 15 00 00       	call   3ac0 <printf>
  unlink("bigfile");
    24d5:	c7 04 24 f0 48 00 00 	movl   $0x48f0,(%esp)
    24dc:	e8 b9 14 00 00       	call   399a <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24e1:	58                   	pop    %eax
    24e2:	5a                   	pop    %edx
    24e3:	68 02 02 00 00       	push   $0x202
    24e8:	68 f0 48 00 00       	push   $0x48f0
    24ed:	e8 90 14 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2518:	53                   	push   %ebx
    2519:	68 60 86 00 00       	push   $0x8660
    251e:	e8 4d 12 00 00       	call   3770 <memset>
    if(write(fd, buf, 600) != 600){
    2523:	83 c4 0c             	add    $0xc,%esp
    2526:	68 58 02 00 00       	push   $0x258
    252b:	68 60 86 00 00       	push   $0x8660
    2530:	56                   	push   %esi
    2531:	e8 54 14 00 00       	call   398a <write>
  ...
  close(fd);
    ...
    254f:	56                   	push   %esi
    2550:	e8 5d 14 00 00       	call   39b2 <close>
  fd = open("bigfile", 0);
    2555:	5e                   	pop    %esi
    2556:	5f                   	pop    %edi
    2557:	6a 00                	push   $0x0
    2559:	68 f0 48 00 00       	push   $0x48f0
    255e:	e8 1f 14 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    258d:	0f be 05 60 86 00 00 	movsbl 0x8660,%eax
    2594:	d1 fa                	sar    $1,%edx
    2596:	39 d0                	cmp    %edx,%eax
    2598:	75 6e                	jne    2608 <bigfile+0x148>
    259a:	0f be 15 8b 87 00 00 	movsbl 0x878b,%edx
  ...
  for(i = 0; ; i++){
    ...
    25b6:	68 60 86 00 00       	push   $0x8660
    25bb:	56                   	push   %esi
    25bc:	e8 71 13 00 00       	call   3932 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25cd:	56                   	push   %esi
    25ce:	e8 df 13 00 00       	call   39b2 <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25e5:	68 f0 48 00 00       	push   $0x48f0
    25ea:	e8 ab 13 00 00       	call   399a <unlink>
  printf(1, "bigfile test ok\n");
    25ef:	58                   	pop    %eax
    25f0:	5a                   	pop    %edx
    25f1:	68 7f 49 00 00       	push   $0x497f
    25f6:	6a 01                	push   $0x1
    ...
    260b:	68 4c 49 00 00       	push   $0x494c
    2610:	6a 01                	push   $0x1
    2612:	e8 a9 14 00 00       	call   3ac0 <printf>
      exit();
    2617:	e8 fe 12 00 00       	call   391a <exit>
      printf(1, "short read bigfile\n");
    261c:	83 ec 08             	sub    $0x8,%esp
    261f:	68 38 49 00 00       	push   $0x4938
    2624:	6a 01                	push   $0x1
    2626:	e8 95 14 00 00       	call   3ac0 <printf>
      exit();
    262b:	e8 ea 12 00 00       	call   391a <exit>
      printf(1, "read bigfile failed\n");
    2630:	83 ec 08             	sub    $0x8,%esp
    2633:	68 23 49 00 00       	push   $0x4923
    2638:	6a 01                	push   $0x1
    263a:	e8 81 14 00 00       	call   3ac0 <printf>
      exit();
    263f:	e8 d6 12 00 00       	call   391a <exit>
      printf(1, "write bigfile failed\n");
    2644:	83 ec 08             	sub    $0x8,%esp
    2647:	68 f8 48 00 00       	push   $0x48f8
    264c:	6a 01                	push   $0x1
    264e:	e8 6d 14 00 00       	call   3ac0 <printf>
      exit();
    2653:	e8 c2 12 00 00       	call   391a <exit>
    printf(1, "cannot open bigfile\n");
    2658:	53                   	push   %ebx
    2659:	53                   	push   %ebx
    265a:	68 0e 49 00 00       	push   $0x490e
    265f:	6a 01                	push   $0x1
    2661:	e8 5a 14 00 00       	call   3ac0 <printf>
    exit();
    2666:	e8 af 12 00 00       	call   391a <exit>
    printf(1, "cannot create bigfile");
    266b:	50                   	push   %eax
    266c:	50                   	push   %eax
    266d:	68 e2 48 00 00       	push   $0x48e2
    2672:	6a 01                	push   $0x1
    2674:	e8 47 14 00 00       	call   3ac0 <printf>
    exit();
    2679:	e8 9c 12 00 00       	call   391a <exit>
    printf(1, "read bigfile wrong total\n");
    267e:	51                   	push   %ecx
    267f:	51                   	push   %ecx
    2680:	68 65 49 00 00       	push   $0x4965
    2685:	6a 01                	push   $0x1
    2687:	e8 34 14 00 00       	call   3ac0 <printf>
    exit();
    268c:	e8 89 12 00 00       	call   391a <exit>
...
000026a0 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    26a6:	68 90 49 00 00       	push   $0x4990
    26ab:	6a 01                	push   $0x1
    26ad:	e8 0e 14 00 00       	call   3ac0 <printf>
  if(mkdir("12345678901234") != 0){
    26b2:	c7 04 24 cb 49 00 00 	movl   $0x49cb,(%esp)
    26b9:	e8 ec 12 00 00       	call   39aa <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26d1:	e8 d4 12 00 00       	call   39aa <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26ee:	e8 8f 12 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2701:	50                   	push   %eax
    2702:	e8 ab 12 00 00       	call   39b2 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2707:	58                   	pop    %eax
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 50 52 00 00       	push   $0x5250
    2710:	e8 6d 12 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    271f:	50                   	push   %eax
    2720:	e8 8d 12 00 00       	call   39b2 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2725:	c7 04 24 bc 49 00 00 	movl   $0x49bc,(%esp)
    272c:	e8 79 12 00 00       	call   39aa <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    2760:	50                   	push   %eax
    2761:	50                   	push   %eax
    2762:	68 9f 49 00 00       	push   $0x499f
    2767:	6a 01                	push   $0x1
    2769:	e8 52 13 00 00       	call   3ac0 <printf>
    exit();
    276e:	e8 a7 11 00 00       	call   391a <exit>
    ...
    exit();
    2781:	e8 94 11 00 00       	call   391a <exit>
    ...
    exit();
    2794:	e8 81 11 00 00       	call   391a <exit>
    ...
    exit();
    27a7:	e8 6e 11 00 00       	call   391a <exit>
    ...
    exit();
    27ba:	e8 5b 11 00 00       	call   391a <exit>
    ...
    exit();
    27cd:	e8 48 11 00 00       	call   391a <exit>
...
000027e0 <rmdot>:
{
  ...
  printf(1, "rmdot ok\n");
    ...
    28b9:	50                   	push   %eax
    28ba:	50                   	push   %eax
    28bb:	68 f8 49 00 00       	push   $0x49f8
    28c0:	6a 01                	push   $0x1
    28c2:	e8 f9 11 00 00       	call   3ac0 <printf>
    exit();
    28c7:	e8 4e 10 00 00       	call   391a <exit>
    printf(1, "unlink dots failed!\n");
    28cc:	50                   	push   %eax
    28cd:	50                   	push   %eax
    28ce:	68 79 4a 00 00       	push   $0x4a79
    28d3:	6a 01                	push   $0x1
    28d5:	e8 e6 11 00 00       	call   3ac0 <printf>
    exit();
    28da:	e8 3b 10 00 00       	call   391a <exit>
    printf(1, "unlink dots/.. worked!\n");
    28df:	52                   	push   %edx
    28e0:	52                   	push   %edx
    28e1:	68 61 4a 00 00       	push   $0x4a61
    28e6:	6a 01                	push   $0x1
    28e8:	e8 d3 11 00 00       	call   3ac0 <printf>
    exit();
    28ed:	e8 28 10 00 00       	call   391a <exit>
    printf(1, "unlink dots/. worked!\n");
    28f2:	51                   	push   %ecx
    28f3:	51                   	push   %ecx
    28f4:	68 42 4a 00 00       	push   $0x4a42
    28f9:	6a 01                	push   $0x1
    28fb:	e8 c0 11 00 00       	call   3ac0 <printf>
    exit();
    2900:	e8 15 10 00 00       	call   391a <exit>
    printf(1, "chdir / failed\n");
    2905:	50                   	push   %eax
    2906:	50                   	push   %eax
    2907:	68 73 3e 00 00       	push   $0x3e73
    290c:	6a 01                	push   $0x1
    290e:	e8 ad 11 00 00       	call   3ac0 <printf>
    exit();
    2913:	e8 02 10 00 00       	call   391a <exit>
    printf(1, "rm .. worked!\n");
    2918:	50                   	push   %eax
    2919:	50                   	push   %eax
    291a:	68 2c 4a 00 00       	push   $0x4a2c
    291f:	6a 01                	push   $0x1
    2921:	e8 9a 11 00 00       	call   3ac0 <printf>
    exit();
    2926:	e8 ef 0f 00 00       	call   391a <exit>
    printf(1, "rm . worked!\n");
    292b:	50                   	push   %eax
    292c:	50                   	push   %eax
    292d:	68 1e 4a 00 00       	push   $0x4a1e
    2932:	6a 01                	push   $0x1
    2934:	e8 87 11 00 00       	call   3ac0 <printf>
    exit();
    2939:	e8 dc 0f 00 00       	call   391a <exit>
    printf(1, "chdir dots failed\n");
    293e:	50                   	push   %eax
    293f:	50                   	push   %eax
    2940:	68 0b 4a 00 00       	push   $0x4a0b
    2945:	6a 01                	push   $0x1
    2947:	e8 74 11 00 00       	call   3ac0 <printf>
    exit();
    294c:	e8 c9 0f 00 00       	call   391a <exit>
...
00002960 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2967:	68 98 4a 00 00       	push   $0x4a98
    296c:	6a 01                	push   $0x1
  ...
  fd = open("dirfile", O_CREATE);
    ...
    297a:	68 a5 4a 00 00       	push   $0x4aa5
    297f:	e8 fe 0f 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2992:	50                   	push   %eax
    2993:	e8 1a 10 00 00       	call   39b2 <close>
  if(chdir("dirfile") == 0){
    2998:	c7 04 24 a5 4a 00 00 	movl   $0x4aa5,(%esp)
    299f:	e8 ae 0f 00 00       	call   3952 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29b2:	6a 00                	push   $0x0
    29b4:	68 de 4a 00 00       	push   $0x4ade
    29b9:	e8 c4 0f 00 00       	call   3982 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29d1:	68 de 4a 00 00       	push   $0x4ade
    29d6:	e8 a7 0f 00 00       	call   3982 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29e9:	68 de 4a 00 00       	push   $0x4ade
    29ee:	e8 b7 0f 00 00       	call   39aa <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a01:	68 de 4a 00 00       	push   $0x4ade
    2a06:	e8 8f 0f 00 00       	call   399a <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a19:	68 de 4a 00 00       	push   $0x4ade
    2a1e:	68 42 4b 00 00       	push   $0x4b42
    2a23:	e8 7a 0f 00 00       	call   39a2 <link>
    2a28:	83 c4 10             	add    $0x10,%esp
    2a2b:	85 c0                	test   %eax,%eax
    2a2d:	0f 84 eb 00 00 00    	je     2b1e <dirfile+0x1be>
  if(unlink("dirfile") != 0){
    2a33:	83 ec 0c             	sub    $0xc,%esp
    2a36:	68 a5 4a 00 00       	push   $0x4aa5
    2a3b:	e8 5a 0f 00 00       	call   399a <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a4e:	6a 02                	push   $0x2
    2a50:	68 9e 46 00 00       	push   $0x469e
    2a55:	e8 28 0f 00 00       	call   3982 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a68:	6a 00                	push   $0x0
    2a6a:	68 9e 46 00 00       	push   $0x469e
    2a6f:	e8 0e 0f 00 00       	call   3982 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    2a7b:	68 81 47 00 00       	push   $0x4781
    2a80:	50                   	push   %eax
    2a81:	e8 04 0f 00 00       	call   398a <write>
  ...
  close(fd);
    ...
    2a90:	53                   	push   %ebx
    2a91:	e8 1c 0f 00 00       	call   39b2 <close>
  printf(1, "dir vs file OK\n");
    2a96:	58                   	pop    %eax
    2a97:	5a                   	pop    %edx
    2a98:	68 75 4b 00 00       	push   $0x4b75
    2a9d:	6a 01                	push   $0x1
    ...
    2aac:	50                   	push   %eax
    2aad:	50                   	push   %eax
    2aae:	68 e9 4a 00 00       	push   $0x4ae9
    2ab3:	6a 01                	push   $0x1
    2ab5:	e8 06 10 00 00       	call   3ac0 <printf>
    exit();
    2aba:	e8 5b 0e 00 00       	call   391a <exit>
    printf(1, "chdir dirfile succeeded!\n");
    2abf:	52                   	push   %edx
    2ac0:	52                   	push   %edx
    2ac1:	68 c4 4a 00 00       	push   $0x4ac4
    2ac6:	6a 01                	push   $0x1
    2ac8:	e8 f3 0f 00 00       	call   3ac0 <printf>
    exit();
    2acd:	e8 48 0e 00 00       	call   391a <exit>
    printf(1, "create dirfile failed\n");
    2ad2:	51                   	push   %ecx
    2ad3:	51                   	push   %ecx
    2ad4:	68 ad 4a 00 00       	push   $0x4aad
    2ad9:	6a 01                	push   $0x1
    2adb:	e8 e0 0f 00 00       	call   3ac0 <printf>
    exit();
    2ae0:	e8 35 0e 00 00       	call   391a <exit>
    printf(1, "write . succeeded!\n");
    2ae5:	51                   	push   %ecx
    2ae6:	51                   	push   %ecx
    2ae7:	68 61 4b 00 00       	push   $0x4b61
    2aec:	6a 01                	push   $0x1
    2aee:	e8 cd 0f 00 00       	call   3ac0 <printf>
    exit();
    2af3:	e8 22 0e 00 00       	call   391a <exit>
    ...
    exit();
    2b06:	e8 0f 0e 00 00       	call   391a <exit>
    printf(1, "unlink dirfile failed!\n");
    2b0b:	50                   	push   %eax
    2b0c:	50                   	push   %eax
    2b0d:	68 49 4b 00 00       	push   $0x4b49
    2b12:	6a 01                	push   $0x1
    2b14:	e8 a7 0f 00 00       	call   3ac0 <printf>
    exit();
    2b19:	e8 fc 0d 00 00       	call   391a <exit>
    ...
    exit();
    2b2c:	e8 e9 0d 00 00       	call   391a <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2b31:	50                   	push   %eax
    2b32:	50                   	push   %eax
    2b33:	68 24 4b 00 00       	push   $0x4b24
    2b38:	6a 01                	push   $0x1
    2b3a:	e8 81 0f 00 00       	call   3ac0 <printf>
    exit();
    2b3f:	e8 d6 0d 00 00       	call   391a <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2b44:	50                   	push   %eax
    2b45:	50                   	push   %eax
    2b46:	68 07 4b 00 00       	push   $0x4b07
    2b4b:	6a 01                	push   $0x1
    2b4d:	e8 6e 0f 00 00       	call   3ac0 <printf>
    exit();
    2b52:	e8 c3 0d 00 00       	call   391a <exit>
    ...
    2b64:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    2b6c:	68 85 4b 00 00       	push   $0x4b85
    2b71:	6a 01                	push   $0x1
    ...
    2b83:	68 96 4b 00 00       	push   $0x4b96
    2b88:	e8 1d 0e 00 00       	call   39aa <mkdir>
    2b8d:	83 c4 10             	add    $0x10,%esp
    2b90:	85 c0                	test   %eax,%eax
    2b92:	0f 85 bb 00 00 00    	jne    2c53 <iref+0xf3>
    if(chdir("irefd") != 0){
    2b98:	83 ec 0c             	sub    $0xc,%esp
    2b9b:	68 96 4b 00 00       	push   $0x4b96
    2ba0:	e8 ad 0d 00 00       	call   3952 <chdir>
    2ba5:	83 c4 10             	add    $0x10,%esp
    2ba8:	85 c0                	test   %eax,%eax
    2baa:	0f 85 b7 00 00 00    	jne    2c67 <iref+0x107>
    mkdir("");
    2bb0:	83 ec 0c             	sub    $0xc,%esp
    2bb3:	68 4b 42 00 00       	push   $0x424b
    2bb8:	e8 ed 0d 00 00       	call   39aa <mkdir>
    link("README", "");
    2bbd:	59                   	pop    %ecx
    2bbe:	58                   	pop    %eax
    2bbf:	68 4b 42 00 00       	push   $0x424b
    2bc4:	68 42 4b 00 00       	push   $0x4b42
    2bc9:	e8 d4 0d 00 00       	call   39a2 <link>
    fd = open("", O_CREATE);
    2bce:	58                   	pop    %eax
    2bcf:	5a                   	pop    %edx
    2bd0:	68 00 02 00 00       	push   $0x200
    2bd5:	68 4b 42 00 00       	push   $0x424b
    2bda:	e8 a3 0d 00 00       	call   3982 <open>
    if(fd >= 0)
    ...
    2be9:	50                   	push   %eax
    2bea:	e8 c3 0d 00 00       	call   39b2 <close>
    2bef:	83 c4 10             	add    $0x10,%esp
    fd = open("xx", O_CREATE);
    2bf2:	83 ec 08             	sub    $0x8,%esp
    2bf5:	68 00 02 00 00       	push   $0x200
    2bfa:	68 80 47 00 00       	push   $0x4780
    2bff:	e8 7e 0d 00 00       	call   3982 <open>
    if(fd >= 0)
    ...
    2c0e:	50                   	push   %eax
    2c0f:	e8 9e 0d 00 00       	call   39b2 <close>
    2c14:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c17:	83 ec 0c             	sub    $0xc,%esp
    2c1a:	68 80 47 00 00       	push   $0x4780
    2c1f:	e8 76 0d 00 00       	call   399a <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c33:	68 71 3e 00 00       	push   $0x3e71
    2c38:	e8 15 0d 00 00       	call   3952 <chdir>
  printf(1, "empty file name OK\n");
    2c3d:	58                   	pop    %eax
    2c3e:	5a                   	pop    %edx
    2c3f:	68 c4 4b 00 00       	push   $0x4bc4
    2c44:	6a 01                	push   $0x1
    ...
    2c56:	68 9c 4b 00 00       	push   $0x4b9c
    2c5b:	6a 01                	push   $0x1
    2c5d:	e8 5e 0e 00 00       	call   3ac0 <printf>
      exit();
    2c62:	e8 b3 0c 00 00       	call   391a <exit>
      printf(1, "chdir irefd failed\n");
    2c67:	83 ec 08             	sub    $0x8,%esp
    2c6a:	68 b0 4b 00 00       	push   $0x4bb0
    2c6f:	6a 01                	push   $0x1
    2c71:	e8 4a 0e 00 00       	call   3ac0 <printf>
      exit();
    2c76:	e8 9f 0c 00 00       	call   391a <exit>
    ...
    2c84:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2c89:	68 d8 4b 00 00       	push   $0x4bd8
    2c8e:	6a 01                	push   $0x1
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cad:	e8 60 0c 00 00       	call   3912 <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cc0:	e8 5d 0c 00 00       	call   3922 <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2ceb:	c3                   	ret
      exit();
    2cec:	e8 29 0c 00 00       	call   391a <exit>
      printf(1, "wait stopped early\n");
    2cf1:	83 ec 08             	sub    $0x8,%esp
    2cf4:	68 e3 4b 00 00       	push   $0x4be3
    2cf9:	6a 01                	push   $0x1
    2cfb:	e8 c0 0d 00 00       	call   3ac0 <printf>
      exit();
    2d00:	e8 15 0c 00 00       	call   391a <exit>
    printf(1, "wait got too many\n");
    2d05:	52                   	push   %edx
    2d06:	52                   	push   %edx
    2d07:	68 f7 4b 00 00       	push   $0x4bf7
    2d0c:	6a 01                	push   $0x1
    2d0e:	e8 ad 0d 00 00       	call   3ac0 <printf>
    exit();
    2d13:	e8 02 0c 00 00       	call   391a <exit>
    printf(1, "fork claimed to work 1000 times!\n");
    2d18:	50                   	push   %eax
    2d19:	50                   	push   %eax
    2d1a:	68 80 53 00 00       	push   $0x5380
    2d1f:	6a 01                	push   $0x1
    2d21:	e8 9a 0d 00 00       	call   3ac0 <printf>
    exit();
    2d26:	e8 ef 0b 00 00       	call   391a <exit>
    ...
    2d34:	31 ff                	xor    %edi,%edi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d75:	6a 01                	push   $0x1
    2d77:	e8 ee 0b 00 00       	call   396a <sbrk>
    if(b != a){
  ...
  pid = fork();
    2d98:	e8 75 0b 00 00       	call   3912 <fork>
  ...
  c = sbrk(1);
    2dad:	6a 01                	push   $0x1
    2daf:	e8 b6 0b 00 00       	call   396a <sbrk>
  c = sbrk(1);
    2db4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dbb:	e8 aa 0b 00 00       	call   396a <sbrk>
  if(c != a + 1){
  ...
  wait();
    2dd3:	e8 4a 0b 00 00       	call   3922 <wait>
  a = sbrk(0);
  ...
  p = sbrk(amt);
    ...
    2dee:	e8 77 0b 00 00       	call   396a <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e08:	6a 00                	push   $0x0
    2e0a:	e8 5b 0b 00 00       	call   396a <sbrk>
  c = sbrk(-4096);
    2e0f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e16:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e18:	e8 4d 0b 00 00       	call   396a <sbrk>
  ...
  c = sbrk(0);
    ...
    2e2c:	6a 00                	push   $0x0
    2e2e:	e8 37 0b 00 00       	call   396a <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e47:	6a 00                	push   $0x0
    2e49:	e8 1c 0b 00 00       	call   396a <sbrk>
  c = sbrk(4096);
    2e4e:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e55:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e57:	e8 0e 0b 00 00       	call   396a <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2ecf:	00 
    ppid = getpid();
    2ed0:	e8 8d 0a 00 00       	call   3962 <getpid>
    2ed5:	89 c7                	mov    %eax,%edi
    pid = fork();
    2ed7:	e8 36 0a 00 00       	call   3912 <fork>
    if(pid < 0){
    ...
    wait();
    2eea:	e8 33 0a 00 00       	call   3922 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f03:	50                   	push   %eax
    2f04:	e8 21 0a 00 00       	call   392a <pipe>
  ...
  if(pipe(fds) != 0){
    ...
    if((pids[i] = fork()) == 0){
    2f20:	e8 ed 09 00 00       	call   3912 <fork>
    ...
    2f3d:	e8 f0 09 00 00       	call   3932 <read>
  ...
  c = sbrk(4096);
    ...
    2f57:	e8 0e 0a 00 00       	call   396a <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	50                   	push   %eax
    2f7b:	e8 ba 09 00 00       	call   393a <kill>
    wait();
    2f80:	e8 9d 09 00 00       	call   3922 <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f9e:	6a 00                	push   $0x0
    2fa0:	e8 c5 09 00 00       	call   396a <sbrk>
    2fa5:	83 c4 10             	add    $0x10,%esp
    2fa8:	39 45 a4             	cmp    %eax,-0x5c(%ebp)
    2fab:	72 65                	jb     3012 <sbrktest+0x2e2>
  printf(stdout, "sbrk test OK\n");
    2fad:	83 ec 08             	sub    $0x8,%esp
    2fb0:	68 c0 4c 00 00       	push   $0x4cc0
    2fb5:	ff 35 1c 5f 00 00    	push   0x5f1c
    2fbb:	e8 00 0b 00 00       	call   3ac0 <printf>
}
    ...
    3035:	53                   	push   %ebx
    3036:	57                   	push   %edi
    3037:	68 23 4c 00 00       	push   $0x4c23
    303c:	ff 35 1c 5f 00 00    	push   0x5f1c
    3042:	e8 79 0a 00 00       	call   3ac0 <printf>
      exit();
    3047:	83 c4 20             	add    $0x20,%esp
    304a:	e8 cb 08 00 00       	call   391a <exit>
      printf(stdout, "fork failed\n");
    304f:	83 ec 08             	sub    $0x8,%esp
    3052:	68 69 4d 00 00       	push   $0x4d69
    3057:	ff 35 1c 5f 00 00    	push   0x5f1c
    305d:	e8 5e 0a 00 00       	call   3ac0 <printf>
      exit();
    3062:	e8 b3 08 00 00       	call   391a <exit>
      printf(stdout, "oops could read %x = %x\n", a, *a);
    3067:	0f be 03             	movsbl (%ebx),%eax
    306a:	50                   	push   %eax
    306b:	53                   	push   %ebx
    306c:	68 8c 4c 00 00       	push   $0x4c8c
    3071:	ff 35 1c 5f 00 00    	push   0x5f1c
    3077:	e8 44 0a 00 00       	call   3ac0 <printf>
      kill(ppid);
    307c:	89 3c 24             	mov    %edi,(%esp)
    307f:	e8 b6 08 00 00       	call   393a <kill>
      exit();
    3084:	e8 91 08 00 00       	call   391a <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    3089:	50                   	push   %eax
    308a:	53                   	push   %ebx
    308b:	68 74 54 00 00       	push   $0x5474
    3090:	ff 35 1c 5f 00 00    	push   0x5f1c
    3096:	e8 25 0a 00 00       	call   3ac0 <printf>
    exit();
    309b:	e8 7a 08 00 00       	call   391a <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    30a0:	56                   	push   %esi
    30a1:	56                   	push   %esi
    30a2:	68 a4 53 00 00       	push   $0x53a4
    30a7:	ff 35 1c 5f 00 00    	push   0x5f1c
    30ad:	e8 0e 0a 00 00       	call   3ac0 <printf>
    exit();
    30b2:	e8 63 08 00 00       	call   391a <exit>
    printf(stdout, "sbrk test fork failed\n");
    30b7:	50                   	push   %eax
    30b8:	50                   	push   %eax
    30b9:	68 3e 4c 00 00       	push   $0x4c3e
    30be:	ff 35 1c 5f 00 00    	push   0x5f1c
    30c4:	e8 f7 09 00 00       	call   3ac0 <printf>
    exit();
    30c9:	e8 4c 08 00 00       	call   391a <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    30ce:	51                   	push   %ecx
    30cf:	51                   	push   %ecx
    30d0:	68 44 54 00 00       	push   $0x5444
    30d5:	ff 35 1c 5f 00 00    	push   0x5f1c
    30db:	e8 e0 09 00 00       	call   3ac0 <printf>
    exit();
    30e0:	e8 35 08 00 00       	call   391a <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    30e5:	50                   	push   %eax
    30e6:	50                   	push   %eax
    30e7:	68 a5 4c 00 00       	push   $0x4ca5
    30ec:	ff 35 1c 5f 00 00    	push   0x5f1c
    30f2:	e8 c9 09 00 00       	call   3ac0 <printf>
    exit();
    30f7:	e8 1e 08 00 00       	call   391a <exit>
    printf(1, "pipe() failed\n");
    30fc:	52                   	push   %edx
    30fd:	52                   	push   %edx
    30fe:	68 61 41 00 00       	push   $0x4161
    3103:	6a 01                	push   $0x1
    3105:	e8 b6 09 00 00       	call   3ac0 <printf>
    exit();
    310a:	e8 0b 08 00 00       	call   391a <exit>
    exit();
    310f:	e8 06 08 00 00       	call   391a <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3114:	57                   	push   %edi
    3115:	57                   	push   %edi
    3116:	68 55 4c 00 00       	push   $0x4c55
    311b:	ff 35 1c 5f 00 00    	push   0x5f1c
    3121:	e8 9a 09 00 00       	call   3ac0 <printf>
    exit();
    3126:	e8 ef 07 00 00       	call   391a <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312b:	57                   	push   %edi
    312c:	53                   	push   %ebx
    312d:	68 1c 54 00 00       	push   $0x541c
    3132:	ff 35 1c 5f 00 00    	push   0x5f1c
    3138:	e8 83 09 00 00       	call   3ac0 <printf>
    exit();
    313d:	e8 d8 07 00 00       	call   391a <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3142:	50                   	push   %eax
    3143:	53                   	push   %ebx
    3144:	68 e4 53 00 00       	push   $0x53e4
    3149:	ff 35 1c 5f 00 00    	push   0x5f1c
    314f:	e8 6c 09 00 00       	call   3ac0 <printf>
    exit();
    3154:	e8 c1 07 00 00       	call   391a <exit>
    printf(stdout, "sbrk could not deallocate\n");
    3159:	53                   	push   %ebx
    315a:	53                   	push   %ebx
    315b:	68 71 4c 00 00       	push   $0x4c71
    3160:	ff 35 1c 5f 00 00    	push   0x5f1c
    3166:	e8 55 09 00 00       	call   3ac0 <printf>
    exit();
    316b:	e8 aa 07 00 00       	call   391a <exit>
    ...
    3184:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    318a:	68 ce 4c 00 00       	push   $0x4cce
    318f:	ff 35 1c 5f 00 00    	push   0x5f1c
    3195:	e8 26 09 00 00       	call   3ac0 <printf>
    319a:	83 c4 10             	add    $0x10,%esp
    319d:	8d 76 00             	lea    0x0(%esi),%esi
    if((pid = fork()) == 0){
    31a0:	e8 6d 07 00 00       	call   3912 <fork>
    ...
    31ae:	6a 00                	push   $0x0
    31b0:	e8 bd 07 00 00       	call   3972 <sleep>
    sleep(0);
    31b5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31bc:	e8 b1 07 00 00       	call   3972 <sleep>
    kill(pid);
    31c1:	89 1c 24             	mov    %ebx,(%esp)
    31c4:	e8 71 07 00 00       	call   393a <kill>
    wait();
    31c9:	e8 54 07 00 00       	call   3922 <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31ce:	58                   	pop    %eax
    31cf:	5a                   	pop    %edx
    31d0:	56                   	push   %esi
    31d1:	68 dd 4c 00 00       	push   $0x4cdd
    31d6:	e8 c7 07 00 00       	call   39a2 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    31f4:	68 01 4d 00 00       	push   $0x4d01
    31f9:	ff 35 1c 5f 00 00    	push   0x5f1c
    ...
    320d:	c3                   	ret
      exit();
    320e:	e8 07 07 00 00       	call   391a <exit>
      printf(stdout, "link should not succeed\n");
    3213:	83 ec 08             	sub    $0x8,%esp
    3216:	68 e8 4c 00 00       	push   $0x4ce8
    321b:	ff 35 1c 5f 00 00    	push   0x5f1c
    3221:	e8 9a 08 00 00       	call   3ac0 <printf>
      exit();
    3226:	e8 ef 06 00 00       	call   391a <exit>
...
00003230 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    3236:	68 0e 4d 00 00       	push   $0x4d0e
    323b:	ff 35 1c 5f 00 00    	push   0x5f1c
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 1c 5f 00 00    	push   0x5f1c
    ...
    3293:	ff 35 1c 5f 00 00    	push   0x5f1c
    3299:	e8 22 08 00 00       	call   3ac0 <printf>
      exit();
    329e:	e8 77 06 00 00       	call   391a <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 da 06 00 00       	call   399a <unlink>
  pid = fork();
    32c0:	e8 4d 06 00 00       	call   3912 <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 4b 06 00 00       	call   3922 <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 36 4d 00 00       	push   $0x4d36
    32e1:	e8 9c 06 00 00       	call   3982 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 b8 06 00 00       	call   39b2 <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 36 4d 00 00 	movl   $0x4d36,(%esp)
    3301:	e8 94 06 00 00       	call   399a <unlink>
}
    3306:	83 c4 10             	add    $0x10,%esp
    3309:	c9                   	leave
    330a:	c3                   	ret
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    330b:	c7 04 85 60 a6 00 00 	movl   $0x5498,0xa660(,%eax,4)
    3312:	98 54 00 00 
    for(i = 0; i < MAXARG-1; i++)
    3316:	b8 01 00 00 00       	mov    $0x1,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    331b:	c7 04 85 60 a6 00 00 	movl   $0x5498,0xa660(,%eax,4)
    3322:	98 54 00 00 
    3326:	c7 04 85 64 a6 00 00 	movl   $0x5498,0xa664(,%eax,4)
    332d:	98 54 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    printf(stdout, "bigarg test\n");
    333c:	50                   	push   %eax
    333d:	68 40 4d 00 00       	push   $0x4d40
    3342:	ff 35 1c 5f 00 00    	push   0x5f1c
    args[MAXARG-1] = 0;
    3348:	89 0d dc a6 00 00    	mov    %ecx,0xa6dc
    printf(stdout, "bigarg test\n");
    334e:	e8 6d 07 00 00       	call   3ac0 <printf>
    exec("echo", args);
    3353:	58                   	pop    %eax
    3354:	5a                   	pop    %edx
    3355:	68 60 a6 00 00       	push   $0xa660
    335a:	68 0d 3f 00 00       	push   $0x3f0d
    335f:	e8 de 05 00 00       	call   3942 <exec>
    printf(stdout, "bigarg test ok\n");
    3364:	59                   	pop    %ecx
    3365:	58                   	pop    %eax
    3366:	68 4d 4d 00 00       	push   $0x4d4d
    336b:	ff 35 1c 5f 00 00    	push   0x5f1c
    3371:	e8 4a 07 00 00       	call   3ac0 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3376:	58                   	pop    %eax
    3377:	5a                   	pop    %edx
    3378:	68 00 02 00 00       	push   $0x200
    337d:	68 36 4d 00 00       	push   $0x4d36
    3382:	e8 fb 05 00 00       	call   3982 <open>
    close(fd);
    3387:	89 04 24             	mov    %eax,(%esp)
    338a:	e8 23 06 00 00       	call   39b2 <close>
    exit();
    338f:	e8 86 05 00 00       	call   391a <exit>
    printf(stdout, "bigarg test failed!\n");
    3394:	50                   	push   %eax
    3395:	50                   	push   %eax
    3396:	68 76 4d 00 00       	push   $0x4d76
    339b:	ff 35 1c 5f 00 00    	push   0x5f1c
    33a1:	e8 1a 07 00 00       	call   3ac0 <printf>
    exit();
    33a6:	e8 6f 05 00 00       	call   391a <exit>
    printf(stdout, "bigargtest: fork failed\n");
    33ab:	52                   	push   %edx
    33ac:	52                   	push   %edx
    33ad:	68 5d 4d 00 00       	push   $0x4d5d
    33b2:	ff 35 1c 5f 00 00    	push   0x5f1c
    33b8:	e8 03 07 00 00       	call   3ac0 <printf>
    exit();
    33bd:	e8 58 05 00 00       	call   391a <exit>
    ...
    33d9:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    33de:	68 8b 4d 00 00       	push   $0x4d8b
    33e3:	6a 01                	push   $0x1
    33e5:	e8 d6 06 00 00       	call   3ac0 <printf>
    ...
    printf(1, "writing %s\n", name);
    345b:	57                   	push   %edi
    345c:	68 98 4d 00 00       	push   $0x4d98
    3461:	6a 01                	push   $0x1
    3463:	e8 58 06 00 00       	call   3ac0 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    3468:	58                   	pop    %eax
    3469:	5a                   	pop    %edx
    346a:	68 02 02 00 00       	push   $0x202
    346f:	57                   	push   %edi
    3470:	e8 0d 05 00 00       	call   3982 <open>
    if(fd < 0){
    ...
    3483:	57                   	push   %edi
    3484:	68 a4 4d 00 00       	push   $0x4da4
    3489:	6a 01                	push   $0x1
    348b:	e8 30 06 00 00       	call   3ac0 <printf>
      break;
    ...
    unlink(name);
    350b:	57                   	push   %edi
    350c:	e8 89 04 00 00       	call   399a <unlink>
  while(nfiles >= 0){
  ...
  printf(1, "fsfull test finished\n");
    ...
    351c:	68 c4 4d 00 00       	push   $0x4dc4
    3521:	6a 01                	push   $0x1
    3523:	e8 98 05 00 00       	call   3ac0 <printf>
}
    ...
    3552:	68 60 86 00 00       	push   $0x8660
    3557:	53                   	push   %ebx
    3558:	e8 2d 04 00 00       	call   398a <write>
      if(cc < 512)
    ...
    3570:	56                   	push   %esi
    3571:	68 b4 4d 00 00       	push   $0x4db4
    3576:	6a 01                	push   $0x1
    3578:	e8 43 05 00 00       	call   3ac0 <printf>
    close(fd);
    357d:	8b 4d a0             	mov    -0x60(%ebp),%ecx
    3580:	89 0c 24             	mov    %ecx,(%esp)
    3583:	e8 2a 04 00 00       	call   39b2 <close>
    if(total == 0)
...
000035a0 <uio>:
{
  ...
  printf(1, "uio test\n");
    35a6:	68 da 4d 00 00       	push   $0x4dda
    35ab:	6a 01                	push   $0x1
    35ad:	e8 0e 05 00 00       	call   3ac0 <printf>
  pid = fork();
    35b2:	e8 5b 03 00 00       	call   3912 <fork>
  if(pid == 0){
  ...
  wait();
    35c0:	e8 5d 03 00 00       	call   3922 <wait>
  printf(1, "uio test done\n");
    35c5:	83 ec 08             	sub    $0x8,%esp
    35c8:	68 e4 4d 00 00       	push   $0x4de4
    35cd:	6a 01                	push   $0x1
    35cf:	e8 ec 04 00 00       	call   3ac0 <printf>
}
    ...
    35ea:	52                   	push   %edx
    35eb:	52                   	push   %edx
    35ec:	68 78 55 00 00       	push   $0x5578
    35f1:	6a 01                	push   $0x1
    35f3:	e8 c8 04 00 00       	call   3ac0 <printf>
    exit();
    35f8:	e8 1d 03 00 00       	call   391a <exit>
    printf (1, "fork failed\n");
    35fd:	50                   	push   %eax
    35fe:	50                   	push   %eax
    35ff:	68 69 4d 00 00       	push   $0x4d69
    3604:	6a 01                	push   $0x1
    3606:	e8 b5 04 00 00       	call   3ac0 <printf>
    exit();
    360b:	e8 0a 03 00 00       	call   391a <exit>
...
00003610 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    3617:	6a 00                	push   $0x0
    3619:	68 f3 4d 00 00       	push   $0x4df3
    361e:	e8 5f 03 00 00       	call   3982 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    363e:	50                   	push   %eax
    363f:	53                   	push   %ebx
    3640:	e8 ed 02 00 00       	call   3932 <read>
  close(fd);
    3645:	89 1c 24             	mov    %ebx,(%esp)
    3648:	e8 65 03 00 00       	call   39b2 <close>
  printf(1, "arg test passed\n");
    364d:	58                   	pop    %eax
    364e:	5a                   	pop    %edx
    364f:	68 05 4e 00 00       	push   $0x4e05
    3654:	6a 01                	push   $0x1
    ...
    3663:	51                   	push   %ecx
    3664:	51                   	push   %ecx
    3665:	68 f8 4d 00 00       	push   $0x4df8
    366a:	6a 02                	push   $0x2
    366c:	e8 4f 04 00 00       	call   3ac0 <printf>
    exit();
    3671:	e8 a4 02 00 00       	call   391a <exit>
...
00003680 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3680:	69 05 18 5f 00 00 0d 	imul   $0x19660d,0x5f18,%eax
    3687:	66 19 00 
    368a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    368f:	a3 18 5f 00 00       	mov    %eax,0x5f18
}
    3694:	c3                   	ret
    ...
    37d9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i = 0; i+1 < max; ){
    ...
    37e5:	56                   	push   %esi
    37e6:	6a 00                	push   $0x0
    37e8:	e8 45 01 00 00       	call   3932 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    383d:	e8 40 01 00 00       	call   3982 <open>
  if(fd < 0)
  ...
  close(fd);
    385c:	e8 51 01 00 00       	call   39b2 <close>
  return r;
...
memmove(void *vdst, const void *vsrc, int n)
{
    ...
    38c7:	8b 45 10             	mov    0x10(%ebp),%eax
    38ca:	56                   	push   %esi
  ...
  src = vsrc;
  if(src > dst){
    38ce:	39 f2                	cmp    %esi,%edx
    38d0:	73 1e                	jae    38f0 <memmove+0x30>
    while(n-- > 0)
    38d2:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
  dst = vdst;
    38d5:	89 d7                	mov    %edx,%edi
    while(n-- > 0)
    38d7:	85 c0                	test   %eax,%eax
    38d9:	7e 0a                	jle    38e5 <memmove+0x25>
    38db:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      *dst++ = *src++;
    38e0:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
    38e1:	39 f9                	cmp    %edi,%ecx
  ...
  return vdst;
    ...
    38e9:	5d                   	pop    %ebp
    38ea:	c3                   	ret
    38eb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    while(n-- > 0)
    38f0:	85 c0                	test   %eax,%eax
    38f2:	7e f1                	jle    38e5 <memmove+0x25>
    while(n-- > 0)
    38f4:	83 e8 01             	sub    $0x1,%eax
    38f7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    38fe:	00 
    38ff:	90                   	nop
      *--dst = *--src;
    3900:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
    3904:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
    3907:	83 e8 01             	sub    $0x1,%eax
    390a:	73 f4                	jae    3900 <memmove+0x40>
}
    390c:	5e                   	pop    %esi
...
/* ---- Standard syscalls ---- */
SYSCALL(fork)
    3912:	b8 01 00 00 00       	mov    $0x1,%eax
    3917:	cd 40                	int    $0x40
    3919:	c3                   	ret

0000391a <exit>:
SYSCALL(exit)
    391a:	b8 02 00 00 00       	mov    $0x2,%eax
    391f:	cd 40                	int    $0x40
    3921:	c3                   	ret

00003922 <wait>:
SYSCALL(wait)
    3922:	b8 03 00 00 00       	mov    $0x3,%eax
    3927:	cd 40                	int    $0x40
    3929:	c3                   	ret

0000392a <pipe>:
SYSCALL(pipe)
    392a:	b8 04 00 00 00       	mov    $0x4,%eax
    392f:	cd 40                	int    $0x40
    3931:	c3                   	ret

00003932 <read>:
SYSCALL(read)
    3932:	b8 05 00 00 00       	mov    $0x5,%eax
    3937:	cd 40                	int    $0x40
    3939:	c3                   	ret

0000393a <kill>:
SYSCALL(kill)
    393a:	b8 06 00 00 00       	mov    $0x6,%eax
    393f:	cd 40                	int    $0x40
    3941:	c3                   	ret

00003942 <exec>:
SYSCALL(exec)
    3942:	b8 07 00 00 00       	mov    $0x7,%eax
    3947:	cd 40                	int    $0x40
    3949:	c3                   	ret
...
00003982 <open>:
SYSCALL(open)
    3982:	b8 0f 00 00 00       	mov    $0xf,%eax
    3987:	cd 40                	int    $0x40
    3989:	c3                   	ret

0000398a <write>:
SYSCALL(write)
    398a:	b8 10 00 00 00       	mov    $0x10,%eax
    398f:	cd 40                	int    $0x40
    3991:	c3                   	ret

00003992 <mknod>:
SYSCALL(mknod)
    3992:	b8 11 00 00 00       	mov    $0x11,%eax
    3997:	cd 40                	int    $0x40
    3999:	c3                   	ret

0000399a <unlink>:
SYSCALL(unlink)
    399a:	b8 12 00 00 00       	mov    $0x12,%eax
    399f:	cd 40                	int    $0x40
    39a1:	c3                   	ret

000039a2 <link>:
SYSCALL(link)
    39a2:	b8 13 00 00 00       	mov    $0x13,%eax
    39a7:	cd 40                	int    $0x40
    39a9:	c3                   	ret

000039aa <mkdir>:
SYSCALL(mkdir)
    39aa:	b8 14 00 00 00       	mov    $0x14,%eax
    39af:	cd 40                	int    $0x40
    39b1:	c3                   	ret

000039b2 <close>:
SYSCALL(close)
    39b2:	b8 15 00 00 00       	mov    $0x15,%eax
    39b7:	cd 40                	int    $0x40
    39b9:	c3                   	ret
...
SYSCALL(setpolicy)
    39ba:	b8 16 00 00 00       	mov    $0x16,%eax
    39bf:	cd 40                	int    $0x40
    39c1:	c3                   	ret

000039c2 <settickets>:
SYSCALL(settickets)
    39c2:	b8 17 00 00 00       	mov    $0x17,%eax
    39c7:	cd 40                	int    $0x40
    39c9:	c3                   	ret

000039ca <getpinfo>:
SYSCALL(getpinfo)
    39ca:	b8 18 00 00 00       	mov    $0x18,%eax
    39cf:	cd 40                	int    $0x40
    39d1:	c3                   	ret

000039d2 <waitx>:
SYSCALL(waitx)
    39d2:	b8 19 00 00 00       	mov    $0x19,%eax
    39d7:	cd 40                	int    $0x40
    39d9:	c3                   	ret

000039da <yield>:
SYSCALL(yield)
    39da:	b8 1a 00 00 00       	mov    $0x1a,%eax
    39df:	cd 40                	int    $0x40
    39e1:	c3                   	ret
    39e2:	66 90                	xchg   %ax,%ax
    39e4:	66 90                	xchg   %ax,%ax
    39e6:	66 90                	xchg   %ax,%ax
    39e8:	66 90                	xchg   %ax,%ax
    39ea:	66 90                	xchg   %ax,%ax
    39ec:	66 90                	xchg   %ax,%ax
    39ee:	66 90                	xchg   %ax,%ax
    39f0:	66 90                	xchg   %ax,%ax
...
{
    3a0a:	83 ec 3c             	sub    $0x3c,%esp
    3a0d:	89 45 c4             	mov    %eax,-0x3c(%ebp)
  if(sgn && xx < 0){
    3a10:	85 d2                	test   %edx,%edx
    3a12:	0f 89 98 00 00 00    	jns    3ab0 <printint+0xb0>
    3a18:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    3a1c:	0f 84 8e 00 00 00    	je     3ab0 <printint+0xb0>
    x = -xx;
    3a22:	f7 d9                	neg    %ecx
    neg = 1;
    3a24:	b8 01 00 00 00       	mov    $0x1,%eax
  } else {
    x = xx;
  }

  i = 0;
    3a29:	89 45 c0             	mov    %eax,-0x40(%ebp)
    3a2c:	31 f6                	xor    %esi,%esi
    3a2e:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3a35:	00 
    3a36:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3a3d:	00 
  ...
  do{
    ...
    3a44:	89 f7                	mov    %esi,%edi
    3a46:	f7 f3                	div    %ebx
    3a48:	8d 76 01             	lea    0x1(%esi),%esi
    3a4b:	0f b6 92 20 56 00 00 	movzbl 0x5620(%edx),%edx
    3a52:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
    3a56:	89 ca                	mov    %ecx,%edx
    3a58:	89 c1                	mov    %eax,%ecx
    3a5a:	39 da                	cmp    %ebx,%edx
    3a5c:	73 e2                	jae    3a40 <printint+0x40>
  if(neg)
    3a5e:	8b 45 c0             	mov    -0x40(%ebp),%eax
    3a61:	85 c0                	test   %eax,%eax
    3a63:	74 07                	je     3a6c <printint+0x6c>
    buf[i++] = '-';
    3a65:	c6 44 35 d8 2d       	movb   $0x2d,-0x28(%ebp,%esi,1)
    3a6a:	89 f7                	mov    %esi,%edi

  while(--i >= 0)
    3a6c:	8d 5d d8             	lea    -0x28(%ebp),%ebx
    3a6f:	8b 75 c4             	mov    -0x3c(%ebp),%esi
    3a72:	01 df                	add    %ebx,%edi
    3a74:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3a7b:	00 
    3a7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
    3a80:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
    3a83:	83 ec 04             	sub    $0x4,%esp
    3a86:	88 45 d7             	mov    %al,-0x29(%ebp)
    3a89:	8d 45 d7             	lea    -0x29(%ebp),%eax
    3a8c:	6a 01                	push   $0x1
    3a8e:	50                   	push   %eax
    3a8f:	56                   	push   %esi
    3a90:	e8 f5 fe ff ff       	call   398a <write>
  while(--i >= 0)
    3a95:	89 f8                	mov    %edi,%eax
    3a97:	83 c4 10             	add    $0x10,%esp
    3a9a:	83 ef 01             	sub    $0x1,%edi
    3a9d:	39 d8                	cmp    %ebx,%eax
    3a9f:	75 df                	jne    3a80 <printint+0x80>
}
    3aa1:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3aa4:	5b                   	pop    %ebx
    3aa5:	5e                   	pop    %esi
    3aa6:	5f                   	pop    %edi
    3aa7:	5d                   	pop    %ebp
    3aa8:	c3                   	ret
    3aa9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  neg = 0;
    3ab0:	31 c0                	xor    %eax,%eax
    3ab2:	e9 72 ff ff ff       	jmp    3a29 <printint+0x29>
    3ab7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3abe:	00 
    3abf:	90                   	nop
    ...
    3ac9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3ad5:	84 d2                	test   %dl,%dl
    3ad7:	0f 84 a0 00 00 00    	je     3b7d <printf+0xbd>
    3add:	8d 45 10             	lea    0x10(%ebp),%eax
    3ae0:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    3ae3:	8b 7d d4             	mov    -0x2c(%ebp),%edi
    3ae6:	0f b6 c2             	movzbl %dl,%eax
    if(state == 0){
    3ae9:	eb 28                	jmp    3b13 <printf+0x53>
    3aeb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
    3af0:	83 ec 04             	sub    $0x4,%esp
    3af3:	8d 45 e7             	lea    -0x19(%ebp),%eax
    3af6:	88 55 e7             	mov    %dl,-0x19(%ebp)
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    3afe:	50                   	push   %eax
    3aff:	56                   	push   %esi
    3b00:	e8 85 fe ff ff       	call   398a <write>
  for(i = 0; fmt[i]; i++){
    3b05:	0f b6 53 ff          	movzbl -0x1(%ebx),%edx
    3b09:	83 c4 10             	add    $0x10,%esp
    3b0c:	84 d2                	test   %dl,%dl
    3b0e:	74 6d                	je     3b7d <printf+0xbd>
    c = fmt[i] & 0xff;
    3b10:	0f b6 c2             	movzbl %dl,%eax
      if(c == '%'){
    3b13:	83 f8 25             	cmp    $0x25,%eax
    3b16:	75 d8                	jne    3af0 <printf+0x30>
  for(i = 0; fmt[i]; i++){
    3b18:	0f b6 13             	movzbl (%ebx),%edx
    3b1b:	84 d2                	test   %dl,%dl
    3b1d:	74 5e                	je     3b7d <printf+0xbd>
    c = fmt[i] & 0xff;
    3b1f:	0f b6 c2             	movzbl %dl,%eax
        state = '%';
      } else {
        putc(fd, c);
      }
      ...
      if(c == 'd'){
    3b22:	80 fa 25             	cmp    $0x25,%dl
    3b25:	0f 84 1d 01 00 00    	je     3c48 <printf+0x188>
    3b2b:	83 e8 63             	sub    $0x63,%eax
    3b2e:	83 f8 15             	cmp    $0x15,%eax
    3b31:	77 0d                	ja     3b40 <printf+0x80>
    3b33:	ff 24 85 c8 55 00 00 	jmp    *0x55c8(,%eax,4)
    3b3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  write(fd, &c, 1);
    3b40:	83 ec 04             	sub    $0x4,%esp
    3b43:	8d 4d e7             	lea    -0x19(%ebp),%ecx
    3b46:	88 55 d0             	mov    %dl,-0x30(%ebp)
        ap++;
      } else if(c == '%'){
        putc(fd, c);
      } else {
        ...
        putc(fd, '%');
    3b49:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
  write(fd, &c, 1);
    3b4d:	6a 01                	push   $0x1
    3b4f:	51                   	push   %ecx
    3b50:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    3b53:	56                   	push   %esi
    3b54:	e8 31 fe ff ff       	call   398a <write>
        putc(fd, c);
    3b59:	0f b6 55 d0          	movzbl -0x30(%ebp),%edx
  write(fd, &c, 1);
    3b5d:	83 c4 0c             	add    $0xc,%esp
    3b60:	88 55 e7             	mov    %dl,-0x19(%ebp)
    3b63:	6a 01                	push   $0x1
    3b65:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
    3b68:	51                   	push   %ecx
    3b69:	56                   	push   %esi
    3b6a:	e8 1b fe ff ff       	call   398a <write>
  for(i = 0; fmt[i]; i++){
    3b6f:	0f b6 53 01          	movzbl 0x1(%ebx),%edx
    3b73:	83 c3 02             	add    $0x2,%ebx
    3b76:	83 c4 10             	add    $0x10,%esp
    3b79:	84 d2                	test   %dl,%dl
    3b7b:	75 93                	jne    3b10 <printf+0x50>
      }
      state = 0;
    }
  }
}
    3b7d:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3b80:	5b                   	pop    %ebx
    3b81:	5e                   	pop    %esi
    3b82:	5f                   	pop    %edi
    3b83:	5d                   	pop    %ebp
    3b84:	c3                   	ret
    3b85:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    3b88:	83 ec 0c             	sub    $0xc,%esp
    3b8b:	8b 17                	mov    (%edi),%edx
    3b8d:	b9 10 00 00 00       	mov    $0x10,%ecx
    3b92:	89 f0                	mov    %esi,%eax
    3b94:	6a 00                	push   $0x0
        ap++;
    3b96:	83 c7 04             	add    $0x4,%edi
        printint(fd, *ap, 16, 0);
    3b99:	e8 62 fe ff ff       	call   3a00 <printint>
  for(i = 0; fmt[i]; i++){
    3b9e:	eb cf                	jmp    3b6f <printf+0xaf>
        s = (char*)*ap;
    3ba0:	8b 07                	mov    (%edi),%eax
        ap++;
    3ba2:	83 c7 04             	add    $0x4,%edi
        if(s == 0)
    3ba5:	85 c0                	test   %eax,%eax
    3ba7:	0f 84 b3 00 00 00    	je     3c60 <printf+0x1a0>
        while(*s != 0){
    3bad:	0f b6 10             	movzbl (%eax),%edx
    3bb0:	84 d2                	test   %dl,%dl
    3bb2:	0f 84 ba 00 00 00    	je     3c72 <printf+0x1b2>
    3bb8:	89 7d d4             	mov    %edi,-0x2c(%ebp)
    3bbb:	89 c7                	mov    %eax,%edi
    3bbd:	89 d0                	mov    %edx,%eax
    3bbf:	8d 4d e7             	lea    -0x19(%ebp),%ecx
    3bc2:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    3bc5:	89 fb                	mov    %edi,%ebx
    3bc7:	89 cf                	mov    %ecx,%edi
    3bc9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
    3bd0:	83 ec 04             	sub    $0x4,%esp
    3bd3:	88 45 e7             	mov    %al,-0x19(%ebp)
          s++;
    3bd6:	83 c3 01             	add    $0x1,%ebx
  write(fd, &c, 1);
    3bd9:	6a 01                	push   $0x1
    3bdb:	57                   	push   %edi
    3bdc:	56                   	push   %esi
    3bdd:	e8 a8 fd ff ff       	call   398a <write>
        while(*s != 0){
    3be2:	0f b6 03             	movzbl (%ebx),%eax
    3be5:	83 c4 10             	add    $0x10,%esp
    3be8:	84 c0                	test   %al,%al
    3bea:	75 e4                	jne    3bd0 <printf+0x110>
    3bec:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  for(i = 0; fmt[i]; i++){
    3bef:	0f b6 53 01          	movzbl 0x1(%ebx),%edx
    3bf3:	83 c3 02             	add    $0x2,%ebx
    3bf6:	84 d2                	test   %dl,%dl
    3bf8:	0f 85 e5 fe ff ff    	jne    3ae3 <printf+0x23>
    3bfe:	e9 7a ff ff ff       	jmp    3b7d <printf+0xbd>
    3c03:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        printint(fd, *ap, 10, 1);
    3c08:	83 ec 0c             	sub    $0xc,%esp
    3c0b:	8b 17                	mov    (%edi),%edx
    3c0d:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3c12:	89 f0                	mov    %esi,%eax
    3c14:	6a 01                	push   $0x1
        ap++;
    3c16:	83 c7 04             	add    $0x4,%edi
        printint(fd, *ap, 10, 1);
    3c19:	e8 e2 fd ff ff       	call   3a00 <printint>
  for(i = 0; fmt[i]; i++){
    3c1e:	e9 4c ff ff ff       	jmp    3b6f <printf+0xaf>
    3c23:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        putc(fd, *ap);
    3c28:	8b 07                	mov    (%edi),%eax
  write(fd, &c, 1);
    3c2a:	83 ec 04             	sub    $0x4,%esp
    3c2d:	8d 4d e7             	lea    -0x19(%ebp),%ecx
        ap++;
    3c30:	83 c7 04             	add    $0x4,%edi
        putc(fd, *ap);
    3c33:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3c36:	6a 01                	push   $0x1
    3c38:	51                   	push   %ecx
    3c39:	56                   	push   %esi
    3c3a:	e8 4b fd ff ff       	call   398a <write>
  for(i = 0; fmt[i]; i++){
    3c3f:	e9 2b ff ff ff       	jmp    3b6f <printf+0xaf>
    3c44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
    3c48:	83 ec 04             	sub    $0x4,%esp
    3c4b:	88 55 e7             	mov    %dl,-0x19(%ebp)
    3c4e:	8d 4d e7             	lea    -0x19(%ebp),%ecx
    3c51:	6a 01                	push   $0x1
    3c53:	e9 10 ff ff ff       	jmp    3b68 <printf+0xa8>
    3c58:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3c5f:	00 
          s = "(null)";
    3c60:	89 7d d4             	mov    %edi,-0x2c(%ebp)
    3c63:	b8 28 00 00 00       	mov    $0x28,%eax
    3c68:	bf 49 4e 00 00       	mov    $0x4e49,%edi
    3c6d:	e9 4d ff ff ff       	jmp    3bbf <printf+0xff>
  for(i = 0; fmt[i]; i++){
    3c72:	0f b6 53 01          	movzbl 0x1(%ebx),%edx
    3c76:	83 c3 02             	add    $0x2,%ebx
    3c79:	84 d2                	test   %dl,%dl
    3c7b:	0f 85 8f fe ff ff    	jne    3b10 <printf+0x50>
    3c81:	e9 f7 fe ff ff       	jmp    3b7d <printf+0xbd>
    3c86:	66 90                	xchg   %ax,%ax
    3c88:	66 90                	xchg   %ax,%ax
    3c8a:	66 90                	xchg   %ax,%ax
    3c8c:	66 90                	xchg   %ax,%ax
    3c8e:	66 90                	xchg   %ax,%ax
    3c90:	66 90                	xchg   %ax,%ax
    3c92:	66 90                	xchg   %ax,%ax
    3c94:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3ca1:	a1 e0 a6 00 00       	mov    0xa6e0,%eax
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3cb1:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3cb8:	00 
    3cb9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3cc0:	89 c2                	mov    %eax,%edx
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3cc2:	8b 00                	mov    (%eax),%eax
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3cc4:	39 ca                	cmp    %ecx,%edx
    3cc6:	73 30                	jae    3cf8 <free+0x58>
    3cc8:	39 c1                	cmp    %eax,%ecx
    3cca:	72 04                	jb     3cd0 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3ccc:	39 c2                	cmp    %eax,%edx
    3cce:	72 f0                	jb     3cc0 <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3cd0:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3cd3:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3cd6:	39 f8                	cmp    %edi,%eax
    3cd8:	74 36                	je     3d10 <free+0x70>
  ...
  if(p + p->s.size == bp){
    ...
    3ce5:	74 40                	je     3d27 <free+0x87>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    3ce7:	89 0a                	mov    %ecx,(%edx)
  } else
    p->s.ptr = bp;
  freep = p;
}
    3ce9:	5b                   	pop    %ebx
  freep = p;
    3cea:	89 15 e0 a6 00 00    	mov    %edx,0xa6e0
}
    3cf0:	5e                   	pop    %esi
    3cf1:	5f                   	pop    %edi
    3cf2:	5d                   	pop    %ebp
    ...
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3cf8:	39 c2                	cmp    %eax,%edx
    3cfa:	72 c4                	jb     3cc0 <free+0x20>
    3cfc:	39 c1                	cmp    %eax,%ecx
    3cfe:	73 c0                	jae    3cc0 <free+0x20>
  if(bp + bp->s.size == p->s.ptr){
    3d00:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3d03:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3d06:	39 f8                	cmp    %edi,%eax
    3d08:	75 d0                	jne    3cda <free+0x3a>
    3d0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    bp->s.size += p->s.ptr->s.size;
    3d10:	03 70 04             	add    0x4(%eax),%esi
    3d13:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3d16:	8b 02                	mov    (%edx),%eax
    3d18:	8b 00                	mov    (%eax),%eax
    3d1a:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    3d1d:	8b 42 04             	mov    0x4(%edx),%eax
    3d20:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    3d23:	39 f1                	cmp    %esi,%ecx
    3d25:	75 c0                	jne    3ce7 <free+0x47>
    p->s.size += bp->s.size;
    3d27:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
    3d2a:	89 15 e0 a6 00 00    	mov    %edx,0xa6e0
    p->s.size += bp->s.size;
    3d30:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    3d33:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    3d36:	89 0a                	mov    %ecx,(%edx)
}
    3d38:	5b                   	pop    %ebx
    3d39:	5e                   	pop    %esi
    3d3a:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3d4c:	8b 15 e0 a6 00 00    	mov    0xa6e0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    3d52:	8d 78 07             	lea    0x7(%eax),%edi
    3d55:	c1 ef 03             	shr    $0x3,%edi
    3d58:	83 c7 01             	add    $0x1,%edi
  if((prevp = freep) == 0){
    3d5b:	85 d2                	test   %edx,%edx
    3d5d:	0f 84 8d 00 00 00    	je     3df0 <malloc+0xb0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d63:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    3d65:	8b 48 04             	mov    0x4(%eax),%ecx
    3d68:	39 f9                	cmp    %edi,%ecx
    3d6a:	73 64                	jae    3dd0 <malloc+0x90>
  if(nu < 4096)
    3d6c:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3d71:	39 df                	cmp    %ebx,%edi
    3d73:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    3d76:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    3d7d:	eb 0a                	jmp    3d89 <malloc+0x49>
    3d7f:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d80:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    3d82:	8b 48 04             	mov    0x4(%eax),%ecx
    3d85:	39 f9                	cmp    %edi,%ecx
    3d87:	73 47                	jae    3dd0 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    3d8b:	39 05 e0 a6 00 00    	cmp    %eax,0xa6e0
    3d91:	75 ed                	jne    3d80 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    3d93:	83 ec 0c             	sub    $0xc,%esp
    3d96:	56                   	push   %esi
    3d97:	e8 ce fb ff ff       	call   396a <sbrk>
  if(p == (char*)-1)
    3d9c:	83 c4 10             	add    $0x10,%esp
    3d9f:	83 f8 ff             	cmp    $0xffffffff,%eax
    3da2:	74 1c                	je     3dc0 <malloc+0x80>
  hp->s.size = nu;
    3da4:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3da7:	83 ec 0c             	sub    $0xc,%esp
    3daa:	83 c0 08             	add    $0x8,%eax
    3dad:	50                   	push   %eax
    3dae:	e8 ed fe ff ff       	call   3ca0 <free>
  return freep;
    3db3:	8b 15 e0 a6 00 00    	mov    0xa6e0,%edx
      if((p = morecore(nunits)) == 0)
    3db9:	83 c4 10             	add    $0x10,%esp
    3dbc:	85 d2                	test   %edx,%edx
    3dbe:	75 c0                	jne    3d80 <malloc+0x40>
        return 0;
  }
}
    3dc0:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    3dca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    3dd0:	39 cf                	cmp    %ecx,%edi
    3dd2:	74 4c                	je     3e20 <malloc+0xe0>
        p->s.size -= nunits;
    3dd4:	29 f9                	sub    %edi,%ecx
    3dd6:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    3dd9:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    3ddc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3ddf:	89 15 e0 a6 00 00    	mov    %edx,0xa6e0
}
    ...
    3def:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    3df0:	c7 05 e0 a6 00 00 e4 	movl   $0xa6e4,0xa6e0
    3df7:	a6 00 00 
    base.s.size = 0;
    3dfa:	b8 e4 a6 00 00       	mov    $0xa6e4,%eax
    base.s.ptr = freep = prevp = &base;
    3dff:	c7 05 e4 a6 00 00 e4 	movl   $0xa6e4,0xa6e4
    3e06:	a6 00 00 
    base.s.size = 0;
    3e09:	c7 05 e8 a6 00 00 00 	movl   $0x0,0xa6e8
    3e10:	00 00 00 
    if(p->s.size >= nunits){
    3e13:	e9 54 ff ff ff       	jmp    3d6c <malloc+0x2c>
    3e18:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3e1f:	00 
        prevp->s.ptr = p->s.ptr;
    3e20:	8b 08                	mov    (%eax),%ecx
    3e22:	89 0a                	mov    %ecx,(%edx)
    3e24:	eb b9                	jmp    3ddf <malloc+0x9f>
