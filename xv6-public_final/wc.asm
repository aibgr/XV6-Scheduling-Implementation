...
main(int argc, char *argv[])
{
  ...
  38:	e8 25 04 00 00       	call   462 <open>
  ...
  59:	e8 34 04 00 00       	call   492 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 8f 03 00 00       	call   3fa <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	52                   	push   %edx
  6c:	50                   	push   %eax
  6d:	68 2b 09 00 00       	push   $0x92b
  72:	6a 01                	push   $0x1
  74:	e8 27 05 00 00       	call   5a0 <printf>
      exit();
  79:	e8 7c 03 00 00       	call   3fa <exit>
    wc(0, "");
  7e:	51                   	push   %ecx
  7f:	51                   	push   %ecx
  80:	68 1d 09 00 00       	push   $0x91d
  85:	6a 00                	push   $0x0
  ...
  aa:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 3d 03 00 00       	call   412 <read>
 ...
 167:	50                   	push   %eax
 168:	50                   	push   %eax
 169:	68 0e 09 00 00       	push   $0x90e
 16e:	6a 01                	push   $0x1
 170:	e8 2b 04 00 00       	call   5a0 <printf>
    exit();
 175:	e8 80 02 00 00       	call   3fa <exit>
 ...
 4e8:	89 d1                	mov    %edx,%ecx
{
 ...
 52b:	0f b6 92 a0 09 00 00 	movzbl 0x9a0(%edx),%edx
 ...
 5a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 613:	ff 24 85 48 09 00 00 	jmp    *0x948(,%eax,4)
 ...
 748:	bf 3f 09 00 00       	mov    $0x93f,%edi
...
free(void *ap)
{
 ...
 781:	a1 a0 0e 00 00       	mov    0xea0,%eax
{
 ...
 7c9:	5b                   	pop    %ebx
  freep = p;
 7ca:	89 15 a0 0e 00 00    	mov    %edx,0xea0
}
 7d0:	5e                   	pop    %esi
 7d1:	5f                   	pop    %edi
 7d2:	5d                   	pop    %ebp
 ...
 807:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 80a:	89 15 a0 0e 00 00    	mov    %edx,0xea0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 829:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 82c:	8b 15 a0 0e 00 00    	mov    0xea0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 86b:	39 05 a0 0e 00 00    	cmp    %eax,0xea0
 ...
 88e:	e8 ed fe ff ff       	call   780 <free>
  return freep;
 893:	8b 15 a0 0e 00 00    	mov    0xea0,%edx
 ...
 8bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 8bf:	89 15 a0 0e 00 00    	mov    %edx,0xea0
}
 ...
 8cf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 8d0:	c7 05 a0 0e 00 00 a4 	movl   $0xea4,0xea0
 8d7:	0e 00 00 
    base.s.size = 0;
 8da:	b8 a4 0e 00 00       	mov    $0xea4,%eax
    base.s.ptr = freep = prevp = &base;
 8df:	c7 05 a4 0e 00 00 a4 	movl   $0xea4,0xea4
 8e6:	0e 00 00 
    base.s.size = 0;
 8e9:	c7 05 a8 0e 00 00 00 	movl   $0x0,0xea8
 8f0:	00 00 00 
    if(p->s.size >= nunits){
