...
_setpolicy:     file format elf32-i386
  ...
  11:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  3a:	e8 3b 03 00 00       	call   37a <setpolicy>
 ...
 3c8:	89 d1                	mov    %edx,%ecx
{
 ...
 40b:	0f b6 92 74 08 00 00 	movzbl 0x874(%edx),%edx
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f3:	ff 24 85 1c 08 00 00 	jmp    *0x81c(,%eax,4)
 ...
 628:	bf 14 08 00 00       	mov    $0x814,%edi
