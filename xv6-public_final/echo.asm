...
main(int argc, char *argv[])
{
  ...
  exit();
  65:	e8 90 02 00 00       	call   2fa <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
  70:	66 90                	xchg   %ax,%ax
 ...
 3e8:	89 d1                	mov    %edx,%ecx
{
 ...
 42b:	0f b6 92 70 08 00 00 	movzbl 0x870(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 513:	ff 24 85 18 08 00 00 	jmp    *0x818(,%eax,4)
 ...
 648:	bf 11 08 00 00       	mov    $0x811,%edi
 ...
 681:	a1 24 0b 00 00       	mov    0xb24,%eax
{
 ...
 6c9:	5b                   	pop    %ebx
  freep = p;
 6ca:	89 15 24 0b 00 00    	mov    %edx,0xb24
}
 6d0:	5e                   	pop    %esi
 6d1:	5f                   	pop    %edi
 6d2:	5d                   	pop    %ebp
 ...
 707:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70a:	89 15 24 0b 00 00    	mov    %edx,0xb24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 76b:	39 05 24 0b 00 00    	cmp    %eax,0xb24
 ...
 78e:	e8 ed fe ff ff       	call   680 <free>
  return freep;
 793:	8b 15 24 0b 00 00    	mov    0xb24,%edx
 ...
 7bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 24 0b 00 00    	mov    %edx,0xb24
}
 ...
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	b8 28 0b 00 00       	mov    $0xb28,%eax
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 28 0b 00 00 28 	movl   $0xb28,0xb28
 7e6:	0b 00 00 
    base.s.size = 0;
