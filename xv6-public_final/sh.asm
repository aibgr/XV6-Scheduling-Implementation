...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2b:	e8 92 0e 00 00       	call   ec2 <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 fd 0d 00 00       	call   e52 <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 fb 0d 00 00       	call   e62 <wait>
  printf(2, "$ ");
  ...
  exit();
      b2:	e8 a3 0d 00 00       	call   e5a <exit>
      close(fd);
      b7:	83 ec 0c             	sub    $0xc,%esp
      ba:	50                   	push   %eax
      bb:	e8 32 0e 00 00       	call   ef2 <close>
      break;
      ...
      f5:	e8 98 0d 00 00       	call   e92 <chdir>
...
00000170 <panic>:
{
  ...
  exit();
     185:	e8 d0 0c 00 00       	call   e5a <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 b7 0c 00 00       	call   e52 <fork>
  if(pid == -1)
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 9f 0c 00 00       	call   e82 <exec>
    ...
    exit();
     1f8:	e8 5d 0c 00 00       	call   e5a <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     211:	50                   	push   %eax
     212:	e8 53 0c 00 00       	call   e6a <pipe>
    ...
    close(p[0]);
     ...
     242:	e8 ab 0c 00 00       	call   ef2 <close>
    close(p[1]);
     247:	58                   	pop    %eax
     248:	ff 75 f4             	push   -0xc(%ebp)
     24b:	e8 a2 0c 00 00       	call   ef2 <close>
    wait();
     250:	e8 0d 0c 00 00       	call   e62 <wait>
    wait();
     255:	e8 08 0c 00 00       	call   e62 <wait>
    break;
    ...
    wait();
     268:	e8 f5 0b 00 00       	call   e62 <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     27e:	e8 6f 0c 00 00       	call   ef2 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     283:	58                   	pop    %eax
     284:	5a                   	pop    %edx
     285:	ff 73 10             	push   0x10(%ebx)
     288:	ff 73 08             	push   0x8(%ebx)
     28b:	e8 32 0c 00 00       	call   ec2 <open>
    ...
    panic("runcmd");
     ...
     2a5:	68 70 13 00 00       	push   $0x1370
     2aa:	e8 c1 fe ff ff       	call   170 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2af:	51                   	push   %ecx
     2b0:	ff 73 08             	push   0x8(%ebx)
     2b3:	68 87 13 00 00       	push   $0x1387
     2b8:	6a 02                	push   $0x2
     2ba:	e8 41 0d 00 00       	call   1000 <printf>
      exit();
     2bf:	e8 96 0b 00 00       	call   e5a <exit>
      panic("pipe");
     2c4:	83 ec 0c             	sub    $0xc,%esp
     2c7:	68 97 13 00 00       	push   $0x1397
     2cc:	e8 9f fe ff ff       	call   170 <panic>
      close(0);
     2d1:	83 ec 0c             	sub    $0xc,%esp
     2d4:	6a 00                	push   $0x0
     2d6:	e8 17 0c 00 00       	call   ef2 <close>
      dup(p[0]);
     2db:	5a                   	pop    %edx
     2dc:	ff 75 f0             	push   -0x10(%ebp)
     2df:	e8 b6 0b 00 00       	call   e9a <dup>
      close(p[0]);
     2e4:	59                   	pop    %ecx
     2e5:	ff 75 f0             	push   -0x10(%ebp)
     2e8:	e8 05 0c 00 00       	call   ef2 <close>
      close(p[1]);
     2ed:	58                   	pop    %eax
     2ee:	ff 75 f4             	push   -0xc(%ebp)
     2f1:	e8 fc 0b 00 00       	call   ef2 <close>
      runcmd(pcmd->right);
     2f6:	58                   	pop    %eax
     ...
     302:	6a 01                	push   $0x1
     304:	e8 e9 0b 00 00       	call   ef2 <close>
      dup(p[1]);
     309:	58                   	pop    %eax
     30a:	ff 75 f4             	push   -0xc(%ebp)
     30d:	e8 88 0b 00 00       	call   e9a <dup>
      close(p[0]);
     312:	58                   	pop    %eax
     313:	ff 75 f0             	push   -0x10(%ebp)
     316:	e8 d7 0b 00 00       	call   ef2 <close>
      close(p[1]);
     31b:	58                   	pop    %eax
     31c:	ff 75 f4             	push   -0xc(%ebp)
     31f:	e8 ce 0b 00 00       	call   ef2 <close>
      runcmd(pcmd->left);
     324:	5a                   	pop    %edx
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 8c 1a 00 00       	push   $0x1a8c
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 8c 1a 00 00       	push   $0x1a8c
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 84 1a 00 00       	push   $0x1a84
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 8c 1a 00 00       	push   $0x1a8c
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 8c 1a 00 00       	push   $0x1a8c
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ac5:	ff 24 85 40 14 00 00 	jmp    *0x1440(,%eax,4)
     ...
     d19:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i = 0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d25:	56                   	push   %esi
     d26:	6a 00                	push   $0x0
     d28:	e8 45 01 00 00       	call   e72 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d7d:	e8 40 01 00 00       	call   ec2 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d91:	50                   	push   %eax
     d92:	e8 f3 00 00 00       	call   e8a <fstat>
  close(fd);
     d97:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d9a:	89 c6                	mov    %eax,%esi
  close(fd);
     d9c:	e8 51 01 00 00       	call   ef2 <close>
  return r;
...
memmove(void *vdst, const void *vsrc, int n)
{
  ...
  src = vsrc;
  if(src > dst){
     e0e:	39 f2                	cmp    %esi,%edx
     e10:	73 1e                	jae    e30 <memmove+0x30>
    while(n-- > 0)
     e12:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
  dst = vdst;
     e15:	89 d7                	mov    %edx,%edi
    while(n-- > 0)
     e17:	85 c0                	test   %eax,%eax
     e19:	7e 0a                	jle    e25 <memmove+0x25>
     e1b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      *dst++ = *src++;
     e20:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
     e21:	39 f9                	cmp    %edi,%ecx
  ...
  return vdst;
    ...
    while(n-- > 0)
     ...
     e32:	7e f1                	jle    e25 <memmove+0x25>
    while(n-- > 0)
     e34:	83 e8 01             	sub    $0x1,%eax
     e37:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     e3e:	00 
     e3f:	90                   	nop
      *--dst = *--src;
     e40:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
     e44:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
     e47:	83 e8 01             	sub    $0x1,%eax
     e4a:	73 f4                	jae    e40 <memmove+0x40>
}
     e4c:	5e                   	pop    %esi
...
00000e5a <exit>:
SYSCALL(exit)
     e5a:	b8 02 00 00 00       	mov    $0x2,%eax
     e5f:	cd 40                	int    $0x40
     e61:	c3                   	ret

00000e62 <wait>:
SYSCALL(wait)
     e62:	b8 03 00 00 00       	mov    $0x3,%eax
     e67:	cd 40                	int    $0x40
     e69:	c3                   	ret

00000e6a <pipe>:
SYSCALL(pipe)
     e6a:	b8 04 00 00 00       	mov    $0x4,%eax
     e6f:	cd 40                	int    $0x40
     e71:	c3                   	ret

00000e72 <read>:
SYSCALL(read)
     e72:	b8 05 00 00 00       	mov    $0x5,%eax
     e77:	cd 40                	int    $0x40
     e79:	c3                   	ret

00000e7a <kill>:
SYSCALL(kill)
     e7a:	b8 06 00 00 00       	mov    $0x6,%eax
     e7f:	cd 40                	int    $0x40
     e81:	c3                   	ret

00000e82 <exec>:
SYSCALL(exec)
     e82:	b8 07 00 00 00       	mov    $0x7,%eax
     e87:	cd 40                	int    $0x40
     e89:	c3                   	ret

00000e8a <fstat>:
SYSCALL(fstat)
     e8a:	b8 08 00 00 00       	mov    $0x8,%eax
     e8f:	cd 40                	int    $0x40
     e91:	c3                   	ret
...
00000ec2 <open>:
SYSCALL(open)
     ec2:	b8 0f 00 00 00       	mov    $0xf,%eax
     ec7:	cd 40                	int    $0x40
     ec9:	c3                   	ret

00000eca <write>:
SYSCALL(write)
     eca:	b8 10 00 00 00       	mov    $0x10,%eax
     ecf:	cd 40                	int    $0x40
     ed1:	c3                   	ret

00000ed2 <mknod>:
SYSCALL(mknod)
     ed2:	b8 11 00 00 00       	mov    $0x11,%eax
     ed7:	cd 40                	int    $0x40
     ed9:	c3                   	ret

00000eda <unlink>:
SYSCALL(unlink)
     eda:	b8 12 00 00 00       	mov    $0x12,%eax
     edf:	cd 40                	int    $0x40
     ee1:	c3                   	ret

00000ee2 <link>:
SYSCALL(link)
     ee2:	b8 13 00 00 00       	mov    $0x13,%eax
     ee7:	cd 40                	int    $0x40
     ee9:	c3                   	ret

00000eea <mkdir>:
SYSCALL(mkdir)
     eea:	b8 14 00 00 00       	mov    $0x14,%eax
     eef:	cd 40                	int    $0x40
     ef1:	c3                   	ret

00000ef2 <close>:
SYSCALL(close)
     ef2:	b8 15 00 00 00       	mov    $0x15,%eax
     ef7:	cd 40                	int    $0x40
     ef9:	c3                   	ret
...
SYSCALL(setpolicy)
     efa:	b8 16 00 00 00       	mov    $0x16,%eax
     eff:	cd 40                	int    $0x40
     f01:	c3                   	ret

00000f02 <settickets>:
SYSCALL(settickets)
     f02:	b8 17 00 00 00       	mov    $0x17,%eax
     f07:	cd 40                	int    $0x40
     f09:	c3                   	ret

00000f0a <getpinfo>:
SYSCALL(getpinfo)
     f0a:	b8 18 00 00 00       	mov    $0x18,%eax
     f0f:	cd 40                	int    $0x40
     f11:	c3                   	ret

00000f12 <waitx>:
SYSCALL(waitx)
     f12:	b8 19 00 00 00       	mov    $0x19,%eax
     f17:	cd 40                	int    $0x40
     f19:	c3                   	ret

00000f1a <yield>:
SYSCALL(yield)
     f1a:	b8 1a 00 00 00       	mov    $0x1a,%eax
     f1f:	cd 40                	int    $0x40
     f21:	c3                   	ret
     ...
     f30:	66 90                	xchg   %ax,%ax
     f32:	66 90                	xchg   %ax,%ax
     f34:	66 90                	xchg   %ax,%ax
     ...
     f48:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f8b:	0f b6 92 b0 14 00 00 	movzbl 0x14b0(%edx),%edx
  ...
  write(fd, &c, 1);
     ...
     fce:	50                   	push   %eax
     fcf:	56                   	push   %esi
     fd0:	e8 f5 fe ff ff       	call   eca <write>
  while(--i >= 0)
    ...
    1009:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    103e:	50                   	push   %eax
    103f:	56                   	push   %esi
    1040:	e8 85 fe ff ff       	call   eca <write>
  for(i = 0; fmt[i]; i++){
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1073:	ff 24 85 58 14 00 00 	jmp    *0x1458(,%eax,4)
  ...
  write(fd, &c, 1);
    ...
    1093:	56                   	push   %esi
    1094:	e8 31 fe ff ff       	call   eca <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    10a8:	51                   	push   %ecx
    10a9:	56                   	push   %esi
    10aa:	e8 1b fe ff ff       	call   eca <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    111b:	57                   	push   %edi
    111c:	56                   	push   %esi
    111d:	e8 a8 fd ff ff       	call   eca <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    1178:	51                   	push   %ecx
    1179:	56                   	push   %esi
    117a:	e8 4b fd ff ff       	call   eca <write>
  for(i = 0; fmt[i]; i++){
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12d6:	56                   	push   %esi
    12d7:	e8 ce fb ff ff       	call   eaa <sbrk>
  if(p == (char*)-1)
