...
main(int argc, char *argv[])
{
  ...
  57:	e8 d6 03 00 00       	call   432 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 31 03 00 00       	call   39a <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	push   (%ebx)
  ...
  73:	e8 c8 04 00 00       	call   540 <printf>
      exit();
  78:	e8 1d 03 00 00       	call   39a <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 0e 03 00 00       	call   39a <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 5a 03 00 00       	call   40a <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 e8 02 00 00       	call   3b2 <read>
  ...
  f9:	e8 42 04 00 00       	call   540 <printf>
    exit();
  fe:	e8 97 02 00 00       	call   39a <exit>
 ...
 549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6e8:	bf e0 08 00 00       	mov    $0x8e0,%edi
 ...
 721:	a1 40 0e 00 00       	mov    0xe40,%eax
{
 ...
 769:	5b                   	pop    %ebx
  freep = p;
 76a:	89 15 40 0e 00 00    	mov    %edx,0xe40
}
 770:	5e                   	pop    %esi
 771:	5f                   	pop    %edi
 772:	5d                   	pop    %ebp
 ...
 7a7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7aa:	89 15 40 0e 00 00    	mov    %edx,0xe40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7cc:	8b 15 40 0e 00 00    	mov    0xe40,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 80b:	39 05 40 0e 00 00    	cmp    %eax,0xe40
 ...
 82e:	e8 ed fe ff ff       	call   720 <free>
  return freep;
 833:	8b 15 40 0e 00 00    	mov    0xe40,%edx
 ...
 877:	0e 00 00 
    base.s.size = 0;
 87a:	b8 44 0e 00 00       	mov    $0xe44,%eax
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 44 0e 00 00 44 	movl   $0xe44,0xe44
 886:	0e 00 00 
    base.s.size = 0;
 889:	c7 05 48 0e 00 00 00 	movl   $0x0,0xe48
 890:	00 00 00 
    if(p->s.size >= nunits){
