...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 40 03 00 00       	call   37a <unlink>
 ...
 3e8:	89 d1                	mov    %edx,%ecx
{
 ...
 42b:	0f b6 92 94 08 00 00 	movzbl 0x894(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 513:	ff 24 85 3c 08 00 00 	jmp    *0x83c(,%eax,4)
 ...
 648:	bf 35 08 00 00       	mov    $0x835,%edi
...
free(void *ap)
{
 ...
 681:	a1 4c 0b 00 00       	mov    0xb4c,%eax
{
 ...
 6c9:	5b                   	pop    %ebx
  freep = p;
 6ca:	89 15 4c 0b 00 00    	mov    %edx,0xb4c
}
 6d0:	5e                   	pop    %esi
 6d1:	5f                   	pop    %edi
 6d2:	5d                   	pop    %ebp
 ...
 707:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70a:	89 15 4c 0b 00 00    	mov    %edx,0xb4c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 4c 0b 00 00    	mov    0xb4c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76b:	39 05 4c 0b 00 00    	cmp    %eax,0xb4c
 ...
 78e:	e8 ed fe ff ff       	call   680 <free>
  return freep;
 793:	8b 15 4c 0b 00 00    	mov    0xb4c,%edx
 ...
 7bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 4c 0b 00 00    	mov    %edx,0xb4c
}
 ...
 7cf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 4c 0b 00 00 50 	movl   $0xb50,0xb4c
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	b8 50 0b 00 00       	mov    $0xb50,%eax
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 50 0b 00 00 50 	movl   $0xb50,0xb50
 7e6:	0b 00 00 
    base.s.size = 0;
 7e9:	c7 05 54 0b 00 00 00 	movl   $0x0,0xb54
 7f0:	00 00 00 
    if(p->s.size >= nunits){
