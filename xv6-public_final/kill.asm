...
main(int argc, char **argv)
{
  ...
  41:	e8 d4 02 00 00       	call   31a <kill>
  for(i=1; i<argc; i++)
  46:	83 c4 10             	add    $0x10,%esp
  49:	39 de                	cmp    %ebx,%esi
  4b:	75 e3                	jne    30 <main+0x30>
  exit();
  4d:	e8 a8 02 00 00       	call   2fa <exit>
    printf(2, "usage: kill pid...\n");
  52:	50                   	push   %eax
  53:	50                   	push   %eax
  54:	68 08 08 00 00       	push   $0x808
  59:	6a 02                	push   $0x2
  5b:	e8 40 04 00 00       	call   4a0 <printf>
    exit();
  60:	e8 95 02 00 00       	call   2fa <exit>
  65:	66 90                	xchg   %ax,%ax
  67:	66 90                	xchg   %ax,%ax
  69:	66 90                	xchg   %ax,%ax
  6b:	66 90                	xchg   %ax,%ax
 ...
 3e8:	89 d1                	mov    %edx,%ecx
{
 ...
 42b:	0f b6 92 7c 08 00 00 	movzbl 0x87c(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 513:	ff 24 85 24 08 00 00 	jmp    *0x824(,%eax,4)
 ...
 648:	bf 1c 08 00 00       	mov    $0x81c,%edi
 ...
 681:	a1 34 0b 00 00       	mov    0xb34,%eax
{
 ...
 6c9:	5b                   	pop    %ebx
  freep = p;
 6ca:	89 15 34 0b 00 00    	mov    %edx,0xb34
}
 6d0:	5e                   	pop    %esi
 6d1:	5f                   	pop    %edi
 6d2:	5d                   	pop    %ebp
 ...
 707:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70a:	89 15 34 0b 00 00    	mov    %edx,0xb34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 34 0b 00 00    	mov    0xb34,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76b:	39 05 34 0b 00 00    	cmp    %eax,0xb34
 ...
 78e:	e8 ed fe ff ff       	call   680 <free>
  return freep;
 793:	8b 15 34 0b 00 00    	mov    0xb34,%edx
 ...
 7bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 34 0b 00 00    	mov    %edx,0xb34
}
 ...
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	b8 38 0b 00 00       	mov    $0xb38,%eax
    base.s.ptr = freep = prevp = &base;
